		...
		<div id="list-contact" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="fullName" title="${message(code: 'contact.fullName.label', default: 'Full Name')}" />
						...
						<g:sortableColumn property="otherNames" title="${message(code: 'contact.otherNames.label', default: 'Other Names')}" />
					
						<g:sortableColumn property="organizationName" title="${message(code: 'contact.organizationName.label', default: 'Organization Name')}" />
					
						<g:sortableColumn property="emailAddress" title="${message(code: 'contact.emailAddress.label', default: 'Email Address')}" />
						<g:sortableColumn property="phone" title="${message(code: 'contact.phone.label', default: 'Phone Number')}" />
						<th>Operation</th>
				...
				<g:each in="${contacts}" status="i" var="contactInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${contactInstance.id}">${fieldValue(bean: contactInstance, field: "fullName")}</g:link></td>
					
						<td>${fieldValue(bean: contactInstance, field: "firstName")}</td>
					
						<td>${fieldValue(bean: contactInstance, field: "lastName")}</td>
					
						<td>${fieldValue(bean: contactInstance, field: "otherNames")}</td>
						
						<td>${fieldValue(bean: contactInstance, field: "organizationName")}</td>
						...
						<td>${fieldValue(bean: contactInstance, field: "phone")}</td>
									...
									<td>
													...
													<g:link class="btn btn-xs btn-teal tooltips" data-placement="top" data-original-title="Edit" action="edit" resource="${contactInstance}">
															<i class="fa fa-edit"></i></g:link>
												<sec:ifAnyGranted roles="ROLE_ADMIN,ROLE_SUPERVISOR">			
													<g:link class="btn btn-xs btn-bricky tooltips" data-placement="top" data-original-title="Remove" action="delete" resource="${contactInstance}">
												...
												<div class="visible-xs visible-sm hidden-md hidden-lg">
													<div class="btn-group">
														...
														<ul role="menu" class="dropdown-menu pull-right">
															...
															<g:link role="menuitem" tabindex="-1" action="edit" resource="${contactInstance}">
															...
															<sec:ifAnyGranted roles="ROLE_ADMIN,ROLE_SUPERVISOR">
																<li role="presentation">
																	...
																	<g:link role="menuitem" tabindex="-1" action="delete" resource="${contactInstance}">
