...
<%--											Add Item</a>--%>
		...
		<div id="list-propertyUse" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="propertyUse" title="${message(code: 'propertyUse.propertyUse.label', default: 'Metro Name')}" />
					
						<g:sortableColumn property="city" title="${message(code: 'propertyUse.city.label', default: 'City')}" />
					
						<g:sortableColumn property="region" title="${message(code: 'propertyUse.region.label', default: 'Region')}" />
					
						<g:sortableColumn property="organizationType" title="${message(code: 'propertyUse.organizationType.label', default: 'Organization Type')}" />
					
						<g:sortableColumn property="enquires" title="${message(code: 'propertyUse.enquires.label', default: 'Enquires')}" />
					
						<g:sortableColumn property="subpropertyUse" title="${message(code: 'propertyUse.subpropertyUse.label', default: 'SubpropertyUse')}" />
						<g:sortableColumn property="electoralArea" title="${message(code: 'propertyUse.electoralArea.label', default: 'Electoral Area')}" />
						<th>Operation</th>
					
					</tr>
				</thead>
				<tbody>
				<g:each in="${propertyUses}" status="i" var="propertyUseInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
					
						<td><g:link action="show" id="${propertyUseInstance.id}">${fieldValue(bean: propertyUseInstance, field: "propertyUse")}</g:link></td>
					
						<td>${fieldValue(bean: propertyUseInstance, field: "city")}</td>
					
						<td>${fieldValue(bean: propertyUseInstance, field: "region")}</td>
					
						<td>${fieldValue(bean: propertyUseInstance, field: "organizationType")}</td>
						
						<td>${fieldValue(bean: propertyUseInstance, field: "enquires")}</td>
						
						<td>${fieldValue(bean: propertyUseInstance, field: "subpropertyUse")}</td>
						<td>${fieldValue(bean: propertyUseInstance, field: "electoralArea")}</td>

									<td>
														<div class="visible-md visible-lg hidden-sm hidden-xs">

													<g:link class="btn btn-xs btn-teal tooltips" data-placement="top" data-original-title="Edit" action="edit" resource="${propertyUseInstance}">
															<i class="fa fa-edit"></i></g:link>
												<sec:ifAnyGranted roles="ROLE_ADMIN,ROLE_SUPERVISOR">			
													<g:link class="btn btn-xs btn-bricky tooltips" data-placement="top" data-original-title="Remove" action="delete" resource="${propertyUseInstance}">
												...
												<div class="visible-xs visible-sm hidden-md hidden-lg">
													<div class="btn-group">
														...
														<ul role="menu" class="dropdown-menu pull-right">
															...
															<g:link role="menuitem" tabindex="-1" action="edit" resource="${propertyUseInstance}">
															...
															<sec:ifAnyGranted roles="ROLE_ADMIN,ROLE_SUPERVISOR">
																<li role="presentation">
																	...
																	<g:link role="menuitem" tabindex="-1" action="delete" resource="${propertyUseInstance}">
...
<%--				<g:paginate total="${propertyUseInstanceCount ?: 0}" />--%>
<%--			</div>--%>
		<!-- end: PAGE CONTENT-->
				</div>
			</div>
