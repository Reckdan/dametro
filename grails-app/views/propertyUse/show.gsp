...
<html>
	<head>
<g:set var="entityName" value="${message(code: 'propertyUse.label', default: 'PropertyUse')}" />
...
<%--													<g:if test="${DatePropertyUse.minus(new Date(),taskInstance.dueDate).getDays<1 }">--%>
<%--													<span class="label label-danger" style="opacity: 1;"> ${taskInstance.dueDate }</span>--%>
<%--													</g:if>--%>
<%--													<g:elseif test="${DatePropertyUse.minus(new Date(),taskInstance.dueDate).getDays>=1 && DatePropertyUse.minus(new Date(),taskInstance.dueDate).getDays<5 }">--%>
...
<div class="col-md-12">
		...
		<div id="show-propertyUse" class="content scaffold-show" role="main">
			...
			<form class="form-horizontal">
				...
				<g:if test="${propertyUseInstance?.code}">
				<div class="form-group">
					
					<label class="col-sm-2 control-label" for="form-field-20">
												<g:message code="propertyUse.code.label" default="Code" />
											</label>
						
						<div class="col-sm-9">
												<input type="text" placeholder="text" value="<g:fieldValue bean="${propertyUseInstance}" field="code"/>" id="form-field-21" class="form-control" disabled="disabled">
											</div>									
				...
				<g:if test="${propertyUseInstance?.propertyUseName}">
				
			<div class="form-group">
					
							<label class="col-sm-2 control-label" for="form-field-20">
												<g:message code="propertyUse.propertyUseName.label" default="PropertyUse Name" />
											</label>
						<div class="col-sm-9">
												<input type="text" placeholder="text" value="<g:fieldValue bean="${propertyUseInstance}" field="propertyUseName"/>" id="form-field-21" class="form-control" disabled="disabled">
											</div>	
				...
				<g:if test="${propertyUseInstance?.minCharge}">
			<div class="form-group">
					
					<label class="col-sm-2 control-label" for="form-field-20">
												<g:message code="propertyUse.minCharge.label" default="Min Charge" />
											</label>
					<div class="col-sm-9">
												<input type="text" placeholder="text" value="<g:fieldValue bean="${propertyUseInstance}" field="minCharge"/>" id="form-field-21" class="form-control" disabled="disabled">
											</div>							
				...
				<g:if test="${propertyUseInstance?.gcatId}">
			<div class="form-group">
					<label class="col-sm-2 control-label" for="form-field-20">
												<g:message code="propertyUse.gcatId.label" default="Gcat Id" />
											</label>
						<div class="col-sm-9">
												<input type="text" placeholder="text" value="<g:fieldValue bean="${propertyUseInstance}" field="gcatId"/>" id="form-field-21" class="form-control" disabled="disabled">
											</div>							
								</div>			
				...
				<g:if test="${propertyUseInstance?.datecreated}">
				<div class="form-group">
					
					<label class="col-sm-2 control-label" for="form-field-20">
												<g:message code="propertyUse.datecreated.label" default="Datecreated" />
											</label>
						<div class="col-sm-9">
												<input type="text" placeholder="text" value="<g:formatDate date="${propertyUseInstance?.datecreated}" />" id="form-field-21" class="form-control" disabled="disabled">
											</div>							
				...
				<g:if test="${propertyUseInstance?.dateupdated}">
					<div class="form-group">
					
					<label class="col-sm-2 control-label" for="form-field-20">
											<g:message code="propertyUse.dateupdated.label" default="Dateupdated" />
											</label>
					<div class="col-sm-9">
												<input type="text" placeholder="text" value="<g:formatDate date="${propertyUseInstance?.dateupdated}" />" id="form-field-21" class="form-control" disabled="disabled">
											</div>							
					</div>	
				...
				<g:if test="${propertyUseInstance?.createdByUser}">
				<div class="form-group">
					
					<label class="col-sm-2 control-label" for="form-field-20">
											<g:message code="propertyUse.createdByUser.label" default="Created By User" />
											</label>
					<div class="col-sm-9">
						<input type="text" placeholder="text" value="<g:fieldValue bean="${propertyUseInstance?.createdByUser}" field="username"/>" id="form-field-21" class="form-control" disabled="disabled">
					</div>	
<%--						<span class="property-value" aria-labelledby="createdByUser-label"><g:link controller="muser" action="show" id="${propertyUseInstance?.createdByUser?.id}">${propertyUseInstance?.createdByUser?.encodeAsHTML()}</g:link></span>--%>
				</div>	
				
				</g:if><%--
			
				<g:if test="${propertyUseInstance?.fixedfees}">
				
					<span id="fixedfees-label" class="property-label"><g:message code="propertyUse.fixedfees.label" default="Fixedfees" /></span>
					
						<g:each in="${propertyUseInstance.fixedfees}" var="f">
				...
				--%><g:if test="${propertyUseInstance?.metro}">
				<div class="form-group">
				
					<label class="col-sm-2 control-label" for="form-field-20">
											<g:message code="propertyUse.metro.label" default="Metro" />
											</label>
					<div class="col-sm-9">
						<input type="text" placeholder="text" value="<g:fieldValue bean="${propertyUseInstance.metro}" field="metro"/>" id="form-field-21" class="form-control" disabled="disabled">
					</div>	
				...
				<g:if test="${propertyUseInstance?.type}">
				<div class="form-group">
				
					<label class="col-sm-2 control-label" for="form-field-20">
											<g:message code="propertyUse.type.label" default="Type" />
											</label>
					<div class="col-sm-9">
						<input type="text" placeholder="text" value="<g:fieldValue bean="${propertyUseInstance.type}" field="typeName"/>" id="form-field-21" class="form-control" disabled="disabled">
					</div>	
					
<%--						<span class="property-value" aria-labelledby="type-label"><g:link controller="eventtype" action="show" id="${propertyUseInstance?.type?.id}">${propertyUseInstance?.type?.typeName.encodeAsHTML()}</g:link></span>--%>
					
				</div>
				</g:if>
			
				<g:if test="${propertyUseInstance?.updatedByUser}">
				
					<div class="form-group">
					<label class="col-sm-2 control-label" for="form-field-20">
											<g:message code="propertyUse.updatedByUser.label" default="Updated By User" />
											</label>
					<div class="col-sm-9">
						<input type="text" placeholder="text" value="<g:fieldValue bean="${propertyUseInstance.updatedByUser}" field="username"/>" id="form-field-21" class="form-control" disabled="disabled">
					</div>	
											
<%--						<span class="property-value" aria-labelledby="updatedByUser-label"><g:link controller="muser" action="show" id="${propertyUseInstance?.updatedByUser?.id}">${propertyUseInstance?.updatedByUser?.encodeAsHTML()}</g:link></span>--%>
					
					</div>
				</g:if>
			
			</form>
			<g:form url="[resource:propertyUseInstance, action:'delete']" method="DELETE">
				<fieldset class="buttons">
					<g:link class="btn btn-primary" action="edit" resource="${propertyUseInstance}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
