...
<%--											Add Item</a>--%>
		...
		<div id="list-permitpayment" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="permitpayment" title="${message(code: 'permitpayment.permitpayment.label', default: 'Metro Name')}" />
					
						<g:sortableColumn property="city" title="${message(code: 'permitpayment.city.label', default: 'City')}" />
					
						<g:sortableColumn property="region" title="${message(code: 'permitpayment.region.label', default: 'Region')}" />
					
						<g:sortableColumn property="organizationType" title="${message(code: 'permitpayment.organizationType.label', default: 'Organization Type')}" />
					
						<g:sortableColumn property="enquires" title="${message(code: 'permitpayment.enquires.label', default: 'Enquires')}" />
					
						<g:sortableColumn property="subpermitpayment" title="${message(code: 'permitpayment.subpermitpayment.label', default: 'Subpermitpayment')}" />
						<g:sortableColumn property="electoralArea" title="${message(code: 'permitpayment.electoralArea.label', default: 'Electoral Area')}" />
						<th>Operation</th>
					
					</tr>
				</thead>
				<tbody>
				<g:each in="${permitpayments}" status="i" var="permitpaymentInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
					
						<td><g:link action="show" id="${permitpaymentInstance.id}">${fieldValue(bean: permitpaymentInstance, field: "permitpayment")}</g:link></td>
					
						<td>${fieldValue(bean: permitpaymentInstance, field: "city")}</td>
					
						<td>${fieldValue(bean: permitpaymentInstance, field: "region")}</td>
					
						<td>${fieldValue(bean: permitpaymentInstance, field: "organizationType")}</td>
						
						<td>${fieldValue(bean: permitpaymentInstance, field: "enquires")}</td>
						
						<td>${fieldValue(bean: permitpaymentInstance, field: "subpermitpayment")}</td>
						<td>${fieldValue(bean: permitpaymentInstance, field: "electoralArea")}</td>

									<td>
														<div class="visible-md visible-lg hidden-sm hidden-xs">

													<g:link class="btn btn-xs btn-teal tooltips" data-placement="top" data-original-title="Edit" action="edit" resource="${permitpaymentInstance}">
															<i class="fa fa-edit"></i></g:link>
												<sec:ifAnyGranted roles="ROLE_ADMIN,ROLE_SUPERVISOR">			
													<g:link class="btn btn-xs btn-bricky tooltips" data-placement="top" data-original-title="Remove" action="delete" resource="${permitpaymentInstance}">
												...
												<div class="visible-xs visible-sm hidden-md hidden-lg">
													<div class="btn-group">
														...
														<ul role="menu" class="dropdown-menu pull-right">
															...
															<g:link role="menuitem" tabindex="-1" action="edit" resource="${permitpaymentInstance}">
															...
															<sec:ifAnyGranted roles="ROLE_ADMIN,ROLE_SUPERVISOR">
																<li role="presentation">
																	...
																	<g:link role="menuitem" tabindex="-1" action="delete" resource="${permitpaymentInstance}">
...
<%--				<g:paginate total="${permitpaymentInstanceCount ?: 0}" />--%>
<%--			</div>--%>
		<!-- end: PAGE CONTENT-->
				</div>
			</div>
