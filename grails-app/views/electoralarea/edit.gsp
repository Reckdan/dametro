...
<%--													<g:else><span class="label label-info" style="opacity: 1;"> ${taskInstance.dueDate }</span></g:else>--%>
		...
		<div class="main-container">
			...
			<g:hasErrors bean="${electoralareaInstance}">
			<ul class="errors" role="alert">
				<g:eachError bean="${electoralareaInstance}" var="error">
				<li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
				</g:eachError>
			</ul>
			</g:hasErrors>
			<g:form url="[resource:electoralareaInstance, action:'update']" method="PUT" class="form-horizontal" >
				<g:hiddenField name="version" value="${electoralareaInstance?.version}" />
				<fieldset class="form">
