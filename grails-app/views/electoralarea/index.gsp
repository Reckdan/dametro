...
<%--											Add Item</a>--%>
		...
		<div id="list-electoralarea" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="electoralarea" title="${message(code: 'electoralarea.electoralAreaName.label', default: 'Electoral Area Name')}" />
					
						<g:sortableColumn property="city" title="${message(code: 'electoralarea.constituency.label', default: 'Constituency')}" />
					
						<g:sortableColumn property="region" title="${message(code: 'electoralarea.submetro.label', default: 'Submetro')}" />
				...
				<tbody>
				<g:each in="${electoralareas}" status="i" var="electoralareaInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
					
						<td><g:link action="show" id="${electoralareaInstance.id}">${fieldValue(bean: electoralareaInstance, field: "electoralAreaName")}</g:link></td>
					
						<td>${fieldValue(bean: electoralareaInstance, field: "constituency.constituencyName")}</td>
					
						<td>${fieldValue(bean: electoralareaInstance, field: "submetro.submetroName")}</td>
					

									<td>
														<div class="visible-md visible-lg hidden-sm hidden-xs">

													<g:link class="btn btn-xs btn-teal tooltips" data-placement="top" data-original-title="Edit" action="edit" resource="${electoralareaInstance}">
															<i class="fa fa-edit"></i></g:link>
												<sec:ifAnyGranted roles="ROLE_ADMIN,ROLE_SUPERVISOR">			
													<g:link class="btn btn-xs btn-bricky tooltips" data-placement="top" data-original-title="Remove" action="delete" resource="${electoralareaInstance}">
												...
												<div class="visible-xs visible-sm hidden-md hidden-lg">
													<div class="btn-group">
														...
														<ul role="menu" class="dropdown-menu pull-right">
															...
															<g:link role="menuitem" tabindex="-1" action="edit" resource="${electoralareaInstance}">
															...
															<sec:ifAnyGranted roles="ROLE_ADMIN,ROLE_SUPERVISOR">
																<li role="presentation">
																	...
																	<g:link role="menuitem" tabindex="-1" action="delete" resource="${electoralareaInstance}">
...
<%--				<g:paginate total="${electoralareaInstanceCount ?: 0}" />--%>
<%--			</div>--%>
		<!-- end: PAGE CONTENT-->
				</div>
			</div>
