...
<%--											Add Item</a>--%>
		...
		<div id="list-gcrtransfer" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="serialrange" title="${message(code: 'gcrtransfer.book.label', default: 'Value Book')}" />
					
						<g:sortableColumn property="fullName" title="${message(code: 'gcrtransfer.transferedfromCollector.label', default: 'Transfer From')}" />
					
						<g:sortableColumn property="fullName" title="${message(code: 'gcrtransfer.transferedtoCollector.label', default: 'Transfer To')}" />
					
						<g:sortableColumn property="datetransferred" title="${message(code: 'gcrtransfer.datetransferred.label', default: 'Transfer Date')}" />
					
						<g:sortableColumn property="isused" title="${message(code: 'gcrtransfer.isused.label', default: 'Is Used')}" />
					
						<g:sortableColumn property="isdamaged" title="${message(code: 'gcrtransfer.isdamaged.label', default: 'Is Damaged')}" />
						<g:sortableColumn property="ismissing" title="${message(code: 'gcrtransfer.ismissing.label', default: 'Is Missing')}" />
						<th>Operation</th>
					
					</tr>
				</thead>
				<tbody>
				<g:each in="${gcrtransfers}" status="i" var="gcrtransferInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
					
						<td><g:link action="show" id="${gcrtransferInstance.id}">${fieldValue(bean: gcrtransferInstance.book, field: "serialrange")}</g:link></td>
					
						<td>${fieldValue(bean: gcrtransferInstance.transferfromCollector, field: "FullName")}</td>
					
						<td>${fieldValue(bean: gcrtransferInstance.transferedtoCollector, field: "fullName")}</td>
					
						<td>${fieldValue(bean: gcrtransferInstance, field: "datetransferred")}</td>
						
						<td>${fieldValue(bean: gcrtransferInstance, field: "isused")}</td>
						
						<td>${fieldValue(bean: gcrtransferInstance, field: "isdamaged")}</td>
						<td>${fieldValue(bean: gcrtransferInstance, field: "ismissing")}</td>

									<td>
														<div class="visible-md visible-lg hidden-sm hidden-xs">

													<g:link class="btn btn-xs btn-teal tooltips" data-placement="top" data-original-title="Edit" action="edit" resource="${gcrtransferInstance}">
															<i class="fa fa-edit"></i></g:link>
												<sec:ifAnyGranted roles="ROLE_ADMIN,ROLE_SUPERVISOR">			
													<g:link class="btn btn-xs btn-bricky tooltips" data-placement="top" data-original-title="Remove" action="delete" resource="${gcrtransferInstance}">
												...
												<div class="visible-xs visible-sm hidden-md hidden-lg">
													<div class="btn-group">
														...
														<ul role="menu" class="dropdown-menu pull-right">
															...
															<g:link role="menuitem" tabindex="-1" action="edit" resource="${gcrtransferInstance}">
															...
															<sec:ifAnyGranted roles="ROLE_ADMIN,ROLE_SUPERVISOR">
																<li role="presentation">
																	...
																	<g:link role="menuitem" tabindex="-1" action="delete" resource="${gcrtransferInstance}">
...
<%--				<g:paginate total="${gcrtransferInstanceCount ?: 0}" />--%>
<%--			</div>--%>
		<!-- end: PAGE CONTENT-->
				</div>
			</div>
