...
<div class="col-md-12">
		...
		<div id="create-gcrtransfer" class="content scaffold-create" role="main">
			
			<g:if test="${flash.message}">
			<div class="message" role="status">${flash.message}</div>
			</g:if>
			<g:hasErrors bean="${gcrtransferInstance}">
			<ul class="errors" role="alert">
				<g:eachError bean="${gcrtransferInstance}" var="error">
			...
			<g:form url="[controller:'gcrtransfer', action:'save']" class="form-horizontal" >
				<fieldset class="form">
