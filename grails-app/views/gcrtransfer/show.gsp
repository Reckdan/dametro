...
<html>
	<head>
<g:set var="entityName" value="${message(code: 'gcrtransfer.label', default: 'Gcrtransfer')}" />
...
<%--													<g:if test="${DateGcrtransfer.minus(new Date(),taskInstance.dueDate).getDays<1 }">--%>
<%--													<span class="label label-danger" style="opacity: 1;"> ${taskInstance.dueDate }</span>--%>
<%--													</g:if>--%>
<%--													<g:elseif test="${DateGcrtransfer.minus(new Date(),taskInstance.dueDate).getDays>=1 && DateGcrtransfer.minus(new Date(),taskInstance.dueDate).getDays<5 }">--%>
...
<div class="col-md-12">
		...
		<div id="show-gcrtransfer" class="content scaffold-show" role="main">
			...
			<form class="form-horizontal">
				...
				<g:if test="${gcrtransferInstance?.book?.serialrange}">
				<div class="form-group">
					
					<label class="col-sm-2 control-label" for="form-field-20">
												<g:message code="gcrtransfer.book.label" default="Value Book" />
											</label>
						
						<div class="col-sm-9">
												<input type="text" placeholder="text" value="<g:fieldValue bean="${gcrtransferInstance.book}" field="serialrange"/>" id="form-field-21" class="form-control" disabled="disabled">
											</div>									
				...
				<g:if test="${gcrtransferInstance?.transferfromCollector?.fullName}">
			<div class="form-group">
					
					<label class="col-sm-2 control-label" for="form-field-20">
												<g:message code="gcrtransfer.transferfromCollector.label" default="Transfered From" />
											</label>
					<div class="col-sm-9">
												<input type="text" placeholder="text" value="<g:fieldValue bean="${gcrtransferInstance.transferfromCollector}" field="fullName"/>" id="form-field-21" class="form-control" disabled="disabled">
											</div>							
				...
				<g:if test="${gcrtransferInstance?.transferedtoCollector?.fullName}">
				
			<div class="form-group">
					
							<label class="col-sm-2 control-label" for="form-field-20">
												<g:message code="gcrtransfer.transferedtoCollector.label" default="Transferred To" />
											</label>
						<div class="col-sm-9">
												<input type="text" placeholder="text" value="<g:fieldValue bean="${gcrtransferInstance.transferedtoCollector}" field="fullName"/>" id="form-field-21" class="form-control" disabled="disabled">
											</div>	
				...
				<g:if test="${gcrtransferInstance?.datetransferred}">
			<div class="form-group">
					<label class="col-sm-2 control-label" for="form-field-20">
												<g:message code="gcrtransfer.datetransferred.label" default="Date of Transfer" />
											</label>
						<div class="col-sm-9">
												<input type="text" placeholder="text" value="<g:fieldValue bean="${gcrtransferInstance}" field="datetransferred"/>" id="form-field-21" class="form-control" disabled="disabled">
											</div>							
								</div>			
				...
				<g:if test="${gcrtransferInstance?.isused}">
				<div class="form-group">
					...
					<label class="col-sm-2 control-label" for="form-field-20">
						...
						<div class="col-sm-3">
						<g:checkBox name="isused"  disabled="disabled" class="square-black" value="<g:fieldValue bean="${gcrtransferInstance}" field="isused"/>" /><g:message code="gcrtransfer.isused.label" default="Is Used" />
												
											</div>	
						<div class="col-sm-3">
						<g:checkBox name="isdamaged"  disabled="disabled" class="square-black" value="<g:fieldValue bean="${gcrtransferInstance}" field="isdamaged"/>" /><g:message code="gcrtransfer.isdamaged.label" default="Is Damaged" />
												
											</div>	
						<div class="col-sm-3">
						<g:checkBox name="ismissing"  disabled="disabled" class="square-black" value="<g:fieldValue bean="${gcrtransferInstance}" field="ismissing"/>" /><g:message code="gcrtransfer.ismissing.label" default="Is Missing" />
			...
			<g:form url="[resource:gcrtransferInstance, action:'delete']" method="DELETE">
				<fieldset class="buttons">
					<g:link class="btn btn-primary" action="edit" resource="${gcrtransferInstance}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
