		...
		<div id="list-business" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="businessName" title="${message(code: 'business.businessName.label', default: 'Name')}" />
					
						<g:sortableColumn property="accountno" title="${message(code: 'business.accountno.label', default: 'Account #')}" />
					
						<g:sortableColumn property="type" title="${message(code: 'business.type.label', default: 'Bus Type')}" />
					
						<g:sortableColumn property="category" title="${message(code: 'business.category.label', default: 'Bus Category')}" />
					
						<g:sortableColumn property="submetro" title="${message(code: 'business.submetro.label', default: 'Sub Metro')}" />
					
						<g:sortableColumn property="constituency" title="${message(code: 'business.constituency.label', default: 'Constituency')}" />
						<g:sortableColumn property="electoralArea" title="${message(code: 'business.electoralarea.label', default: 'Electoral Area')}" />
				...
				<tbody>
				<g:each in="${businesss}" status="i" var="businessInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
					
						<td><g:link action="show" id="${businessInstance.id}">${fieldValue(bean: businessInstance, field: "businessName")}</g:link></td>
						<td>${fieldValue(bean: businessInstance, field: "accountno")}</td>
						<td>${fieldValue(bean: businessInstance, field: "type.typeName")}</td>
					
						<td>${fieldValue(bean: businessInstance, field: "category.categoryName")}</td>
					
						<td>${fieldValue(bean: businessInstance, field: "submetro.submetroName")}</td>
						
						<td>${fieldValue(bean: businessInstance, field: "constituency.constituencyName")}</td>
						
						<td>${fieldValue(bean: businessInstance, field: "electoralarea.electoralareaName")}</td>
						<td>${fieldValue(bean: businessInstance, field: "phone")}</td>
						<td>${fieldValue(bean: businessInstance, field: "email")}</td>
									<td>
														<div class="visible-md visible-lg hidden-sm hidden-xs">
													<g:link class="btn btn-xs btn-bricky tooltips" data-placement="top" data-original-title="Payment" action="payment" resource="${businessInstance}">
															<i class="fa fa-credit-card"></i></g:link>		

													<g:link class="btn btn-xs btn-teal tooltips" data-placement="top" data-original-title="Edit" action="edit" resource="${businessInstance}">
															<i class="fa fa-edit"></i></g:link>
												<sec:ifAnyGranted roles="ROLE_ADMIN,ROLE_SUPERVISOR">			
													<g:link class="btn btn-xs btn-bricky tooltips" data-placement="top" data-original-title="Remove" action="delete" resource="${businessInstance}">
													...
													<div class="btn-group">
														...
														<ul role="menu" class="dropdown-menu pull-right">
															<li role="presentation">
																<g:link role="menuitem" tabindex="-1" action="payment" resource="${businessInstance}">
																	<i class="fa fa-times"></i> Payment
																</g:link>
																</li>
															<li role="presentation">
															<g:link role="menuitem" tabindex="-1" action="edit" resource="${businessInstance}">
															...
															<sec:ifAnyGranted roles="ROLE_ADMIN,ROLE_SUPERVISOR">
																<li role="presentation">
																	...
																	<g:link role="menuitem" tabindex="-1" action="delete" resource="${businessInstance}">
