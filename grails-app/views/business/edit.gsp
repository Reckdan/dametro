...
<%--													<g:else><span class="label label-info" style="opacity: 1;"> ${taskInstance.dueDate }</span></g:else>--%>
		...
		<div class="main-container">
			...
			<g:form url="[resource:businessInstance, action:'update']" method="PUT" class="form-horizontal" >
...
<%--		<g:javascript library="icheck"/>--%>
		<g:javascript library="jqueryformwizard"/>
		<g:javascript library="formwizard"/>
