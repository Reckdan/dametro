...
<html>
	<head>
<g:set var="entityName" value="${message(code: 'gcrserial.label', default: 'Category')}" />
...
<%--											Add Item</a>--%>
		...
		<div id="list-gcrserial" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="gcrserial" title="${message(code: 'gcrserial.gcrserial.label', default: 'Metro Name')}" />
					
						<g:sortableColumn property="city" title="${message(code: 'gcrserial.city.label', default: 'City')}" />
					
						<g:sortableColumn property="region" title="${message(code: 'gcrserial.region.label', default: 'Region')}" />
					
						<g:sortableColumn property="organizationType" title="${message(code: 'gcrserial.organizationType.label', default: 'Organization Type')}" />
					
						<g:sortableColumn property="enquires" title="${message(code: 'gcrserial.enquires.label', default: 'Enquires')}" />
					
						<g:sortableColumn property="subgcrserial" title="${message(code: 'gcrserial.subgcrserial.label', default: 'Subgcrserial')}" />
						<g:sortableColumn property="electoralArea" title="${message(code: 'gcrserial.electoralArea.label', default: 'Electoral Area')}" />
						<th>Operation</th>
					
					</tr>
				</thead>
				<tbody>
				<g:each in="${gcrserials}" status="i" var="gcrserialInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
					
						<td><g:link action="show" id="${gcrserialInstance.id}">${fieldValue(bean: gcrserialInstance, field: "gcrserial")}</g:link></td>
					
						<td>${fieldValue(bean: gcrserialInstance, field: "city")}</td>
					
						<td>${fieldValue(bean: gcrserialInstance, field: "region")}</td>
					
						<td>${fieldValue(bean: gcrserialInstance, field: "organizationType")}</td>
						
						<td>${fieldValue(bean: gcrserialInstance, field: "enquires")}</td>
						
						<td>${fieldValue(bean: gcrserialInstance, field: "subgcrserial")}</td>
						<td>${fieldValue(bean: gcrserialInstance, field: "electoralArea")}</td>

									<td>
														<div class="visible-md visible-lg hidden-sm hidden-xs">

													<g:link class="btn btn-xs btn-teal tooltips" data-placement="top" data-original-title="Edit" action="edit" resource="${gcrserialInstance}">
															<i class="fa fa-edit"></i></g:link>
												<sec:ifAnyGranted roles="ROLE_ADMIN,ROLE_SUPERVISOR">			
													<g:link class="btn btn-xs btn-bricky tooltips" data-placement="top" data-original-title="Remove" action="delete" resource="${gcrserialInstance}">
												...
												<div class="visible-xs visible-sm hidden-md hidden-lg">
													<div class="btn-group">
														...
														<ul role="menu" class="dropdown-menu pull-right">
															...
															<g:link role="menuitem" tabindex="-1" action="edit" resource="${gcrserialInstance}">
															...
															<sec:ifAnyGranted roles="ROLE_ADMIN,ROLE_SUPERVISOR">
																<li role="presentation">
																	...
																	<g:link role="menuitem" tabindex="-1" action="delete" resource="${gcrserialInstance}">
...
<%--				<g:paginate total="${gcrserialInstanceCount ?: 0}" />--%>
<%--			</div>--%>
		<!-- end: PAGE CONTENT-->
				</div>
			</div>
