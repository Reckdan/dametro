...
<html>
	<head>
<g:set var="entityName" value="${message(code: 'eventtype.label', default: 'Type')}" />
			...
			<form class="form-horizontal">
				...
				<div class="form-group">
					...
					<label class="col-sm-2 control-label" for="form-field-20">
						...
						<div class="col-sm-9">
												<input type="text" placeholder="text" value="<g:fieldValue bean="${typeInstance}" field="code"/>" id="form-field-21" class="form-control" disabled="disabled">
											</div>									
				...
				<g:if test="${typeInstance?.typeName}">
				
			<div class="form-group">
					
							<label class="col-sm-2 control-label" for="form-field-20">
												<g:message code="type.typeName.label" default="Category Name" />
											</label>
						<div class="col-sm-9">
												<input type="text" placeholder="text" value="<g:fieldValue bean="${typeInstance}" field="typeName"/>" id="form-field-21" class="form-control" disabled="disabled">
											</div>	
				...
				<g:if test="${typeInstance?.budgetCode}">
			<div class="form-group">
					...
					<div class="col-sm-9">
												<input type="text" placeholder="text" value="<g:fieldValue bean="${typeInstance}" field="budgetCode"/>" id="form-field-21" class="form-control" disabled="disabled">
											</div>							
				...
				<g:if test="${typeInstance?.gcatId}">
			<div class="form-group">
					<label class="col-sm-2 control-label" for="form-field-20">
												<g:message code="type.gcatId.label" default="Gcat Id" />
											</label>
						<div class="col-sm-9">
												<input type="text" placeholder="text" value="<g:fieldValue bean="${typeInstance}" field="gcatId"/>" id="form-field-21" class="form-control" disabled="disabled">
											</div>							
								</div>			
				...
				<div class="form-group">
					...
					<label class="col-sm-2 control-label" for="form-field-20">
						...
						<div class="col-sm-9">
												<input type="text" placeholder="text" value="<g:formatDate date="${typeInstance?.dateCreated}" />" id="form-field-21" class="form-control" disabled="disabled">
											</div>							
				...
				<g:if test="${typeInstance?.dateUpdated}">
					<div class="form-group">
					...
					<div class="col-sm-9">
												<input type="text" placeholder="text" value="<g:formatDate date="${typeInstance?.dateUpdated}" />" id="form-field-21" class="form-control" disabled="disabled">
											</div>							
					</div>	
				...
				<g:if test="${typeInstance?.createdByUser}">
				<div class="form-group">
					
					<label class="col-sm-2 control-label" for="form-field-20">
											<g:message code="type.createdByUser.label" default="Created By User" />
											</label>
					<div class="col-sm-9">
						<input type="text" placeholder="text" value="<g:fieldValue bean="${typeInstance?.createdByUser}" field="username"/>" id="form-field-21" class="form-control" disabled="disabled">
					</div>	
<%--						<span class="property-value" aria-labelledby="createdByUser-label"><g:link controller="muser" action="show" id="${typeInstance?.createdByUser?.id}">${typeInstance?.createdByUser?.encodeAsHTML()}</g:link></span>--%>
				</div>	
				
				</g:if><%--
			
				<g:if test="${typeInstance?.fixedfees}">
				
					<span id="fixedfees-label" class="property-label"><g:message code="type.fixedfees.label" default="Fixedfees" /></span>
				...
				--%><g:if test="${typeInstance?.metro}">
				<div class="form-group">
				
					<label class="col-sm-2 control-label" for="form-field-20">
											<g:message code="type.metro.label" default="Metro" />
											</label>
					<div class="col-sm-9">
						<input type="text" placeholder="text" value="<g:fieldValue bean="${typeInstance.metro}" field="metro"/>" id="form-field-21" class="form-control" disabled="disabled">
					</div>	
				...
				<g:if test="${typeInstance?.updatedByUser}">
					...
					<div class="col-sm-9">
						<input type="text" placeholder="text" value="<g:fieldValue bean="${typeInstance.updatedByUser}" field="username"/>" id="form-field-21" class="form-control" disabled="disabled">
					</div>	
											
<%--						<span class="property-value" aria-labelledby="updatedByUser-label"><g:link controller="muser" action="show" id="${typeInstance?.updatedByUser?.id}">${typeInstance?.updatedByUser?.encodeAsHTML()}</g:link></span>--%>
			...
			<g:form url="[resource:typeInstance, action:'delete']" method="DELETE">
				<fieldset class="buttons">
					<g:link class="btn btn-primary" action="edit" resource="${typeInstance}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
