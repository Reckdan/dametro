...
<%--													<g:if test="${DateType.minus(new Date(),taskInstance.dueDate).getDays<1 }">--%>
<%--													<span class="label label-danger" style="opacity: 1;"> ${taskInstance.dueDate }</span>--%>
<%--													</g:if>--%>
<%--													<g:elseif test="${DateType.minus(new Date(),taskInstance.dueDate).getDays>=1 && DateType.minus(new Date(),taskInstance.dueDate).getDays<5 }">--%>
		...
		<div id="list-type" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="typeName" title="${message(code: 'eventtype.typeName.label', default: 'Type Name')}" />
					
						<g:sortableColumn property="budgetCode" title="${message(code: 'eventtype.budgetCode.label', default: 'Budget Code')}" />
					
						<g:sortableColumn property="gcatId" title="${message(code: 'eventtype.gcatId.label', default: 'Gcat Id')}" />
					
						<g:sortableColumn property="dateCreated" title="${message(code: 'eventtype.dateCreated.label', default: 'Date Created')}" />
					
						<g:sortableColumn property="dateUpdated" title="${message(code: 'eventtype.dateUpdated.label', default: 'Date Updated')}" />
						<th>Operation</th>
					
					</tr>
				</thead>
				<tbody>
				<g:each in="${types}" status="i" var="typeInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
					
						<td><g:link action="show" id="${typeInstance.id}">${fieldValue(bean: typeInstance, field: "code")}</g:link></td>
					
						<td>${fieldValue(bean: typeInstance, field: "typeName")}</td>
					
						<td>${fieldValue(bean: typeInstance, field: "budgetCode")}</td>
					
						<td>${fieldValue(bean: typeInstance, field: "gcatId")}</td>
					
						<td><g:formatDate date="${typeInstance.dateCreated}" /></td>
					
						<td><g:formatDate date="${typeInstance.dateUpdated}" /></td>
									<td>
														<div class="visible-md visible-lg hidden-sm hidden-xs">

													<g:link class="btn btn-xs btn-teal tooltips" data-placement="top" data-original-title="Edit" action="edit" resource="${typeInstance}">
															<i class="fa fa-edit"></i></g:link>
												<sec:ifAnyGranted roles="ROLE_ADMIN,ROLE_SUPERVISOR">			
													<g:link class="btn btn-xs btn-bricky tooltips" data-placement="top" data-original-title="Remove" action="delete" resource="${typeInstance}">
												...
												<div class="visible-xs visible-sm hidden-md hidden-lg">
													<div class="btn-group">
														...
														<ul role="menu" class="dropdown-menu pull-right">
															...
															<g:link role="menuitem" tabindex="-1" action="edit" resource="${typeInstance}">
															...
															<sec:ifAnyGranted roles="ROLE_ADMIN,ROLE_SUPERVISOR">
																<li role="presentation">
																	...
																	<g:link role="menuitem" tabindex="-1" action="delete" resource="${typeInstance}">
