...
<html>
	<head>
<g:set var="entityName" value="${message(code: 'permitinfo.label', default: 'Permitinfo')}" />
...
<%--													<g:if test="${DatePermitinfo.minus(new Date(),taskInstance.dueDate).getDays<1 }">--%>
<%--													<span class="label label-danger" style="opacity: 1;"> ${taskInstance.dueDate }</span>--%>
<%--													</g:if>--%>
<%--													<g:elseif test="${DatePermitinfo.minus(new Date(),taskInstance.dueDate).getDays>=1 && DatePermitinfo.minus(new Date(),taskInstance.dueDate).getDays<5 }">--%>
...
<div class="col-md-12">
		...
		<div id="show-permitinfo" class="content scaffold-show" role="main">
			...
			<form class="form-horizontal">
				...
				<g:if test="${permitinfoInstance?.code}">
				<div class="form-group">
					
					<label class="col-sm-2 control-label" for="form-field-20">
												<g:message code="permitinfo.code.label" default="Code" />
											</label>
						
						<div class="col-sm-9">
												<input type="text" placeholder="text" value="<g:fieldValue bean="${permitinfoInstance}" field="code"/>" id="form-field-21" class="form-control" disabled="disabled">
											</div>									
				...
				<g:if test="${permitinfoInstance?.permitinfoName}">
				
			<div class="form-group">
					
							<label class="col-sm-2 control-label" for="form-field-20">
												<g:message code="permitinfo.permitinfoName.label" default="Permitinfo Name" />
											</label>
						<div class="col-sm-9">
												<input type="text" placeholder="text" value="<g:fieldValue bean="${permitinfoInstance}" field="permitinfoName"/>" id="form-field-21" class="form-control" disabled="disabled">
											</div>	
				...
				<g:if test="${permitinfoInstance?.minCharge}">
			<div class="form-group">
					
					<label class="col-sm-2 control-label" for="form-field-20">
												<g:message code="permitinfo.minCharge.label" default="Min Charge" />
											</label>
					<div class="col-sm-9">
												<input type="text" placeholder="text" value="<g:fieldValue bean="${permitinfoInstance}" field="minCharge"/>" id="form-field-21" class="form-control" disabled="disabled">
											</div>							
				...
				<g:if test="${permitinfoInstance?.gcatId}">
			<div class="form-group">
					<label class="col-sm-2 control-label" for="form-field-20">
												<g:message code="permitinfo.gcatId.label" default="Gcat Id" />
											</label>
						<div class="col-sm-9">
												<input type="text" placeholder="text" value="<g:fieldValue bean="${permitinfoInstance}" field="gcatId"/>" id="form-field-21" class="form-control" disabled="disabled">
											</div>							
								</div>			
				...
				<g:if test="${permitinfoInstance?.datecreated}">
				<div class="form-group">
					
					<label class="col-sm-2 control-label" for="form-field-20">
												<g:message code="permitinfo.datecreated.label" default="Datecreated" />
											</label>
						<div class="col-sm-9">
												<input type="text" placeholder="text" value="<g:formatDate date="${permitinfoInstance?.datecreated}" />" id="form-field-21" class="form-control" disabled="disabled">
											</div>							
				...
				<g:if test="${permitinfoInstance?.dateupdated}">
					<div class="form-group">
					
					<label class="col-sm-2 control-label" for="form-field-20">
											<g:message code="permitinfo.dateupdated.label" default="Dateupdated" />
											</label>
					<div class="col-sm-9">
												<input type="text" placeholder="text" value="<g:formatDate date="${permitinfoInstance?.dateupdated}" />" id="form-field-21" class="form-control" disabled="disabled">
											</div>							
					</div>	
				...
				<g:if test="${permitinfoInstance?.createdByUser}">
				<div class="form-group">
					
					<label class="col-sm-2 control-label" for="form-field-20">
											<g:message code="permitinfo.createdByUser.label" default="Created By User" />
											</label>
					<div class="col-sm-9">
						<input type="text" placeholder="text" value="<g:fieldValue bean="${permitinfoInstance?.createdByUser}" field="username"/>" id="form-field-21" class="form-control" disabled="disabled">
					</div>	
<%--						<span class="property-value" aria-labelledby="createdByUser-label"><g:link controller="muser" action="show" id="${permitinfoInstance?.createdByUser?.id}">${permitinfoInstance?.createdByUser?.encodeAsHTML()}</g:link></span>--%>
				</div>	
				
				</g:if><%--
			
				<g:if test="${permitinfoInstance?.fixedfees}">
				
					<span id="fixedfees-label" class="property-label"><g:message code="permitinfo.fixedfees.label" default="Fixedfees" /></span>
					
						<g:each in="${permitinfoInstance.fixedfees}" var="f">
				...
				--%><g:if test="${permitinfoInstance?.metro}">
				<div class="form-group">
				
					<label class="col-sm-2 control-label" for="form-field-20">
											<g:message code="permitinfo.metro.label" default="Metro" />
											</label>
					<div class="col-sm-9">
						<input type="text" placeholder="text" value="<g:fieldValue bean="${permitinfoInstance.metro}" field="metro"/>" id="form-field-21" class="form-control" disabled="disabled">
					</div>	
				...
				<g:if test="${permitinfoInstance?.type}">
				<div class="form-group">
				
					<label class="col-sm-2 control-label" for="form-field-20">
											<g:message code="permitinfo.type.label" default="Type" />
											</label>
					<div class="col-sm-9">
						<input type="text" placeholder="text" value="<g:fieldValue bean="${permitinfoInstance.type}" field="typeName"/>" id="form-field-21" class="form-control" disabled="disabled">
					</div>	
					
<%--						<span class="property-value" aria-labelledby="type-label"><g:link controller="eventtype" action="show" id="${permitinfoInstance?.type?.id}">${permitinfoInstance?.type?.typeName.encodeAsHTML()}</g:link></span>--%>
					
				</div>
				</g:if>
			
				<g:if test="${permitinfoInstance?.updatedByUser}">
				
					<div class="form-group">
					<label class="col-sm-2 control-label" for="form-field-20">
											<g:message code="permitinfo.updatedByUser.label" default="Updated By User" />
											</label>
					<div class="col-sm-9">
						<input type="text" placeholder="text" value="<g:fieldValue bean="${permitinfoInstance.updatedByUser}" field="username"/>" id="form-field-21" class="form-control" disabled="disabled">
					</div>	
											
<%--						<span class="property-value" aria-labelledby="updatedByUser-label"><g:link controller="muser" action="show" id="${permitinfoInstance?.updatedByUser?.id}">${permitinfoInstance?.updatedByUser?.encodeAsHTML()}</g:link></span>--%>
					
					</div>
				</g:if>
			
			</form>
			<g:form url="[resource:permitinfoInstance, action:'delete']" method="DELETE">
				<fieldset class="buttons">
					<g:link class="btn btn-primary" action="edit" resource="${permitinfoInstance}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
