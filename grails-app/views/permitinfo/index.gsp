...
<%--											Add Item</a>--%>
		...
		<div id="list-permitinfo" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="permitinfo" title="${message(code: 'permitinfo.permitinfo.label', default: 'Metro Name')}" />
					
						<g:sortableColumn property="city" title="${message(code: 'permitinfo.city.label', default: 'City')}" />
					
						<g:sortableColumn property="region" title="${message(code: 'permitinfo.region.label', default: 'Region')}" />
					
						<g:sortableColumn property="organizationType" title="${message(code: 'permitinfo.organizationType.label', default: 'Organization Type')}" />
					
						<g:sortableColumn property="enquires" title="${message(code: 'permitinfo.enquires.label', default: 'Enquires')}" />
					
						<g:sortableColumn property="subpermitinfo" title="${message(code: 'permitinfo.subpermitinfo.label', default: 'Subpermitinfo')}" />
						<g:sortableColumn property="electoralArea" title="${message(code: 'permitinfo.electoralArea.label', default: 'Electoral Area')}" />
						<th>Operation</th>
					
					</tr>
				</thead>
				<tbody>
				<g:each in="${permitinfos}" status="i" var="permitinfoInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
					
						<td><g:link action="show" id="${permitinfoInstance.id}">${fieldValue(bean: permitinfoInstance, field: "permitinfo")}</g:link></td>
					
						<td>${fieldValue(bean: permitinfoInstance, field: "city")}</td>
					
						<td>${fieldValue(bean: permitinfoInstance, field: "region")}</td>
					
						<td>${fieldValue(bean: permitinfoInstance, field: "organizationType")}</td>
						
						<td>${fieldValue(bean: permitinfoInstance, field: "enquires")}</td>
						
						<td>${fieldValue(bean: permitinfoInstance, field: "subpermitinfo")}</td>
						<td>${fieldValue(bean: permitinfoInstance, field: "electoralArea")}</td>

									<td>
														<div class="visible-md visible-lg hidden-sm hidden-xs">

													<g:link class="btn btn-xs btn-teal tooltips" data-placement="top" data-original-title="Edit" action="edit" resource="${permitinfoInstance}">
															<i class="fa fa-edit"></i></g:link>
												<sec:ifAnyGranted roles="ROLE_ADMIN,ROLE_SUPERVISOR">			
													<g:link class="btn btn-xs btn-bricky tooltips" data-placement="top" data-original-title="Remove" action="delete" resource="${permitinfoInstance}">
												...
												<div class="visible-xs visible-sm hidden-md hidden-lg">
													<div class="btn-group">
														...
														<ul role="menu" class="dropdown-menu pull-right">
															...
															<g:link role="menuitem" tabindex="-1" action="edit" resource="${permitinfoInstance}">
															...
															<sec:ifAnyGranted roles="ROLE_ADMIN,ROLE_SUPERVISOR">
																<li role="presentation">
																	...
																	<g:link role="menuitem" tabindex="-1" action="delete" resource="${permitinfoInstance}">
...
<%--				<g:paginate total="${permitinfoInstanceCount ?: 0}" />--%>
<%--			</div>--%>
		<!-- end: PAGE CONTENT-->
				</div>
			</div>
