		...
		<div id="list-unit" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="unitName" title="${message(code: 'unit.unitName.label', default: 'Unit Committee')}" />
					
						<g:sortableColumn property="electoraAreaName" title="${message(code: 'unit.electoralarea.label', default: 'Electoral Area')}" />
					
						<g:sortableColumn property="constituencyName" title="${message(code: 'unit.constituency.label', default: 'Constituency')}" />
					
						<g:sortableColumn property="submetroName" title="${message(code: 'unit.submetro.label', default: 'Sub Metro')}" />
				...
				<tbody>
				<g:each in="${units}" status="i" var="unitInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
					
						<td><g:link action="show" id="${unitInstance.id}">${fieldValue(bean: unitInstance, field: "unitName")}</g:link></td>
					
						<td>${fieldValue(bean: unitInstance, field: "electoralarea.electoralAreaName")}</td>
					
						<td>${fieldValue(bean: unitInstance, field: "constituency.constituencyName")}</td>
					
						<td>${fieldValue(bean: unitInstance, field: "submetro.submetroName")}</td>
									...
									<td>
													...
													<g:link class="btn btn-xs btn-teal tooltips" data-placement="top" data-original-title="Edit" action="edit" resource="${unitInstance}">
															<i class="fa fa-edit"></i></g:link>
												<sec:ifAnyGranted roles="ROLE_ADMIN,ROLE_SUPERVISOR">			
													<g:link class="btn btn-xs btn-bricky tooltips" data-placement="top" data-original-title="Remove" action="delete" resource="${unitInstance}">
												...
												<div class="visible-xs visible-sm hidden-md hidden-lg">
													<div class="btn-group">
														...
														<ul role="menu" class="dropdown-menu pull-right">
															...
															<g:link role="menuitem" tabindex="-1" action="edit" resource="${unitInstance}">
															...
															<sec:ifAnyGranted roles="ROLE_ADMIN,ROLE_SUPERVISOR">
																<li role="presentation">
																	...
																	<g:link role="menuitem" tabindex="-1" action="delete" resource="${unitInstance}">
