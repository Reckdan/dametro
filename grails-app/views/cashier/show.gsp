...
<html>
	<head>
<g:set var="entityName" value="${message(code: 'cashier.label', default: 'Cashier')}" />
...
<%--													<g:if test="${DateCashier.minus(new Date(),taskInstance.dueDate).getDays<1 }">--%>
<%--													<span class="label label-danger" style="opacity: 1;"> ${taskInstance.dueDate }</span>--%>
<%--													</g:if>--%>
<%--													<g:elseif test="${DateCashier.minus(new Date(),taskInstance.dueDate).getDays>=1 && DateCashier.minus(new Date(),taskInstance.dueDate).getDays<5 }">--%>
...
<div class="col-md-12">
		...
		<div id="show-cashier" class="content scaffold-show" role="main">
			...
			<form class="form-horizontal">
				...
				<g:if test="${cashierInstance?.firstName}">
				<div class="form-group">
					...
					<label class="col-sm-2 control-label" for="form-field-20">
						...
						<div class="col-sm-9">
												<input type="text" placeholder="text" value="<g:fieldValue bean="${cashierInstance}" field="firstName"/>" id="form-field-21" class="form-control" disabled="disabled">
											</div>									
				...
				<g:if test="${cashierInstance?.lastName}">
			...
			<div class="form-group">
						...
						<div class="col-sm-9">
												<input type="text" placeholder="text" value="<g:fieldValue bean="${cashierInstance}" field="lastName"/>" id="form-field-21" class="form-control" disabled="disabled">
											</div>	
				...
				<g:if test="${cashierInstance?.otherNames}">
			<div class="form-group">
					...
					<div class="col-sm-9">
												<input type="text" placeholder="text" value="<g:fieldValue bean="${cashierInstance}" field="otherNames"/>" id="form-field-21" class="form-control" disabled="disabled">
											</div>							
				...
				<g:if test="${cashierInstance?.houseAddress}">
			<div class="form-group">
					<label class="col-sm-2 control-label" for="form-field-20">
												<g:message code="cashier.houseAddress.label" default="Home Address" />
											</label>
						<div class="col-sm-9">
												<input type="text" placeholder="text" value="<g:fieldValue bean="${cashierInstance}" field="houseAddress"/>" id="form-field-21" class="form-control" disabled="disabled">
											</div>							
								</div>			
				...
				<g:if test="${cashierInstance?.postalAddress}">
			<div class="form-group">
					<label class="col-sm-2 control-label" for="form-field-20">
												<g:message code="cashier.postalAddress.label" default="Postal Address" />
											</label>
						<div class="col-sm-9">
												<input type="text" placeholder="text" value="<g:fieldValue bean="${cashierInstance}" field="postalAddress"/>" id="form-field-21" class="form-control" disabled="disabled">
											</div>							
								</div>			
					
			
				</g:if>
				<g:if test="${cashierInstance?.telephone}">
			<div class="form-group">
					<label class="col-sm-2 control-label" for="form-field-20">
												<g:message code="cashier.telephone.label" default="Telephone" />
											</label>
						<div class="col-sm-9">
												<input type="text" placeholder="text" value="<g:fieldValue bean="${cashierInstance}" field="telephone"/>" id="form-field-21" class="form-control" disabled="disabled">
											</div>							
								</div>			
					...
					<g:if test="${cashierInstance?.email}">
			<div class="form-group">
					<label class="col-sm-2 control-label" for="form-field-20">
												<g:message code="cashier.email.label" default="Email" />
											</label>
						<div class="col-sm-9">
												<input type="text" placeholder="text" value="<g:fieldValue bean="${cashierInstance}" field="email"/>" id="form-field-21" class="form-control" disabled="disabled">
											</div>							
								</div>			
					
			
				</g:if>
			<g:if test="${cashierInstance?.pctCommission}">
			<div class="form-group">
					<label class="col-sm-2 control-label" for="form-field-20">
												<g:message code="cashier.pctCommission.label" default="Percentage Commission" />
											</label>
						<div class="col-sm-9">
												<input type="text" placeholder="text" value="<g:fieldValue bean="${cashierInstance}" field="pctCommission"/>" id="form-field-21" class="form-control" disabled="disabled">
											</div>							
								</div>			
					
			
				</g:if>
				<g:if test="${cashierInstance?.dateAdded}">
				<div class="form-group">
					
					<label class="col-sm-2 control-label" for="form-field-20">
												<g:message code="cashier.dateAdded.label" default="date Added" />
											</label>
						<div class="col-sm-9">
												<input type="text" placeholder="text" value="<g:formatDate date="${cashierInstance?.dateAdded}" />" id="form-field-21" class="form-control" disabled="disabled">
											</div>							
				...
				<g:if test="${cashierInstance?.dateUpdated}">
					<div class="form-group">
					
					<label class="col-sm-2 control-label" for="form-field-20">
											<g:message code="cashier.dateUpdated.label" default="date Updated" />
											</label>
					<div class="col-sm-9">
												<input type="text" placeholder="text" value="<g:formatDate date="${cashierInstance?.dateUpdated}" />" id="form-field-21" class="form-control" disabled="disabled">
											</div>							
					</div>	
				...
				<g:if test="${cashierInstance?.addedByUser}">
				<div class="form-group">
					
					<label class="col-sm-2 control-label" for="form-field-20">
											<g:message code="cashier.addedByUser.label" default="Created By User" />
											</label>
					<div class="col-sm-9">
						<input type="text" placeholder="text" value="<g:fieldValue bean="${cashierInstance?.addedByUser}" field="username"/>" id="form-field-21" class="form-control" disabled="disabled">
					</div>	
<%--						<span class="property-value" aria-labelledby="createdByUser-label"><g:link controller="muser" action="show" id="${cashierInstance?.createdByUser?.id}">${cashierInstance?.createdByUser?.encodeAsHTML()}</g:link></span>--%>
				</div>	
				
				</g:if><%--
			
				<g:if test="${cashierInstance?.fixedfees}">
				
					<span id="fixedfees-label" class="property-label"><g:message code="cashier.fixedfees.label" default="Fixedfees" /></span>
				...
				--%><g:if test="${cashierInstance?.metro}">
				<div class="form-group">
				
					<label class="col-sm-2 control-label" for="form-field-20">
											<g:message code="cashier.metro.label" default="Metro" />
											</label>
					<div class="col-sm-9">
						<input type="text" placeholder="text" value="<g:fieldValue bean="${cashierInstance.metro}" field="metro"/>" id="form-field-21" class="form-control" disabled="disabled">
					</div>	
				...
				<g:if test="${cashierInstance?.updatedByUser}">
					...
					<div class="col-sm-9">
						<input type="text" placeholder="text" value="<g:fieldValue bean="${cashierInstance.updatedByUser}" field="username"/>" id="form-field-21" class="form-control" disabled="disabled">
					</div>	
											
<%--						<span class="property-value" aria-labelledby="updatedByUser-label"><g:link controller="muser" action="show" id="${cashierInstance?.updatedByUser?.id}">${cashierInstance?.updatedByUser?.encodeAsHTML()}</g:link></span>--%>
					
					</div>
				</g:if>
			
			</form>
			<g:form url="[resource:cashierInstance, action:'delete']" method="DELETE">
				<fieldset class="buttons">
					<g:link class="btn btn-primary" action="edit" resource="${cashierInstance}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
