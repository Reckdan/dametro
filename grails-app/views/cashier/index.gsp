...
<%--											Add Item</a>--%>
		...
		<div id="list-cashier" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="fullName" title="${message(code: 'cashier.fullName.label', default: 'Full Name')}" />
					
						<g:sortableColumn property="firstName" title="${message(code: 'cashier.firstName.label', default: 'First Name')}" />
					
						<g:sortableColumn property="lastName" title="${message(code: 'cashier.lastName.label', default: 'Last Name')}" />
					
						<g:sortableColumn property="otherNames" title="${message(code: 'cashier.otherNames.label', default: 'Other Names')}" />
					
						<g:sortableColumn property="houseAddress" title="${message(code: 'cashier.houseAddress.label', default: 'Home Address')}" />
					
						<g:sortableColumn property="postalAddress" title="${message(code: 'cashier.postalAddress.label', default: 'Postal Address')}" />
						<g:sortableColumn property="telephone" title="${message(code: 'cashier.telephone.label', default: 'Phone')}" />
						<g:sortableColumn property="email" title="${message(code: 'cashier.email.label', default: 'Email')}" />
						<g:sortableColumn property="pctCommission" title="${message(code: 'cashier.pctCommission.label', default: 'Percentage Commission')}" />
						<th>Operation</th>
					
					</tr>
				</thead>
				<tbody>
				<g:each in="${cashiers}" status="i" var="cashierInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
					
						<td><g:link action="show" id="${cashierInstance.id}">${fieldValue(bean: cashierInstance, field: "fullName")}</g:link></td>
					
						<td>${fieldValue(bean: cashierInstance, field: "firstName")}</td>
					
						<td>${fieldValue(bean: cashierInstance, field: "lastName")}</td>
					
						<td>${fieldValue(bean: cashierInstance, field: "otherNames")}</td>
						
						<td>${fieldValue(bean: cashierInstance, field: "houseAddress")}</td>
						
						<td>${fieldValue(bean: cashierInstance, field: "postalAddress")}</td>
						<td>${fieldValue(bean: cashierInstance, field: "telphone")}</td>
						<td>${fieldValue(bean: cashierInstance, field: "email")}</td>
						<td>${fieldValue(bean: cashierInstance, field: "pctCommission")}</td>

									<td>
														<div class="visible-md visible-lg hidden-sm hidden-xs">

													<g:link class="btn btn-xs btn-teal tooltips" data-placement="top" data-original-title="Edit" action="edit" resource="${cashierInstance}">
															<i class="fa fa-edit"></i></g:link>
												<sec:ifAnyGranted roles="ROLE_ADMIN,ROLE_SUPERVISOR">			
													<g:link class="btn btn-xs btn-bricky tooltips" data-placement="top" data-original-title="Remove" action="delete" resource="${cashierInstance}">
												...
												<div class="visible-xs visible-sm hidden-md hidden-lg">
													<div class="btn-group">
														...
														<ul role="menu" class="dropdown-menu pull-right">
															...
															<g:link role="menuitem" tabindex="-1" action="edit" resource="${cashierInstance}">
															...
															<sec:ifAnyGranted roles="ROLE_ADMIN,ROLE_SUPERVISOR">
																<li role="presentation">
																	...
																	<g:link role="menuitem" tabindex="-1" action="delete" resource="${cashierInstance}">
...
<%--				<g:paginate total="${cashierInstanceCount ?: 0}" />--%>
<%--			</div>--%>
		<!-- end: PAGE CONTENT-->
				</div>
			</div>
