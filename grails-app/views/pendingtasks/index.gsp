...
<%--											Add Item</a>--%>
		...
		<div id="list-pendingtask" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="pendingtask" title="${message(code: 'pendingtask.pendingtask.label', default: 'Metro Name')}" />
					
						<g:sortableColumn property="city" title="${message(code: 'pendingtask.city.label', default: 'City')}" />
					
						<g:sortableColumn property="region" title="${message(code: 'pendingtask.region.label', default: 'Region')}" />
					
						<g:sortableColumn property="organizationType" title="${message(code: 'pendingtask.organizationType.label', default: 'Organization Type')}" />
					
						<g:sortableColumn property="enquires" title="${message(code: 'pendingtask.enquires.label', default: 'Enquires')}" />
					
						<g:sortableColumn property="subpendingtask" title="${message(code: 'pendingtask.subpendingtask.label', default: 'Subpendingtask')}" />
						<g:sortableColumn property="electoralArea" title="${message(code: 'pendingtask.electoralArea.label', default: 'Electoral Area')}" />
						<th>Operation</th>
					
					</tr>
				</thead>
				<tbody>
				<g:each in="${pendingtasks}" status="i" var="pendingtaskInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
					
						<td><g:link action="show" id="${pendingtaskInstance.id}">${fieldValue(bean: pendingtaskInstance, field: "pendingtask")}</g:link></td>
					
						<td>${fieldValue(bean: pendingtaskInstance, field: "city")}</td>
					
						<td>${fieldValue(bean: pendingtaskInstance, field: "region")}</td>
					
						<td>${fieldValue(bean: pendingtaskInstance, field: "organizationType")}</td>
						
						<td>${fieldValue(bean: pendingtaskInstance, field: "enquires")}</td>
						
						<td>${fieldValue(bean: pendingtaskInstance, field: "subpendingtask")}</td>
						<td>${fieldValue(bean: pendingtaskInstance, field: "electoralArea")}</td>

									<td>
														<div class="visible-md visible-lg hidden-sm hidden-xs">

													<g:link class="btn btn-xs btn-teal tooltips" data-placement="top" data-original-title="Edit" action="edit" resource="${pendingtaskInstance}">
															<i class="fa fa-edit"></i></g:link>
												<sec:ifAnyGranted roles="ROLE_ADMIN,ROLE_SUPERVISOR">			
													<g:link class="btn btn-xs btn-bricky tooltips" data-placement="top" data-original-title="Remove" action="delete" resource="${pendingtaskInstance}">
												...
												<div class="visible-xs visible-sm hidden-md hidden-lg">
													<div class="btn-group">
														...
														<ul role="menu" class="dropdown-menu pull-right">
															...
															<g:link role="menuitem" tabindex="-1" action="edit" resource="${pendingtaskInstance}">
															...
															<sec:ifAnyGranted roles="ROLE_ADMIN,ROLE_SUPERVISOR">
																<li role="presentation">
																	...
																	<g:link role="menuitem" tabindex="-1" action="delete" resource="${pendingtaskInstance}">
...
<%--				<g:paginate total="${pendingtaskInstanceCount ?: 0}" />--%>
<%--			</div>--%>
		<!-- end: PAGE CONTENT-->
				</div>
			</div>
