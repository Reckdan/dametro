		...
		<div id="list-building" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="building" title="${message(code: 'building.building.label', default: 'Metro Name')}" />
					
						<g:sortableColumn property="city" title="${message(code: 'building.city.label', default: 'City')}" />
					
						<g:sortableColumn property="region" title="${message(code: 'building.region.label', default: 'Region')}" />
					
						<g:sortableColumn property="organizationType" title="${message(code: 'building.organizationType.label', default: 'Organization Type')}" />
					
						<g:sortableColumn property="enquires" title="${message(code: 'building.enquires.label', default: 'Enquires')}" />
					
						<g:sortableColumn property="subbuilding" title="${message(code: 'building.subbuilding.label', default: 'Subbuilding')}" />
				...
				<g:each in="${buildings}" status="i" var="buildingInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${buildingInstance.id}">${fieldValue(bean: buildingInstance, field: "building")}</g:link></td>
					
						<td>${fieldValue(bean: buildingInstance, field: "city")}</td>
					
						<td>${fieldValue(bean: buildingInstance, field: "region")}</td>
					
						<td>${fieldValue(bean: buildingInstance, field: "organizationType")}</td>
						
						<td>${fieldValue(bean: buildingInstance, field: "enquires")}</td>
						
						<td>${fieldValue(bean: buildingInstance, field: "subbuilding")}</td>
						<td>${fieldValue(bean: buildingInstance, field: "electoralArea")}</td>

									<td>
												<div class="visible-md visible-lg hidden-sm hidden-xs">
													<g:link class="btn btn-xs btn-teal tooltips" data-placement="top" data-original-title="Payment" action="payment" resource="${buildingInstance}">
															<i class="fa fa-credit-card"></i></g:link>
												...
												<div class="visible-xs visible-sm hidden-md hidden-lg">
													<div class="btn-group">
														...
														<ul role="menu" class="dropdown-menu pull-right">
															...
															<g:link role="menuitem" tabindex="-1" action="payment" resource="${buildingInstance}">
															<i class="fa fa-credit-card"></i>
															<g:message code="default.button.payment.label" default="Payment" /></g:link>
