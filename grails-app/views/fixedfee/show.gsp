...
<html>
	<head>
<g:set var="entityName" value="${message(code: 'fixedfee.label', default: 'Fixedfee')}" />
...
<%--													<g:if test="${DateFixedfee.minus(new Date(),taskInstance.dueDate).getDays<1 }">--%>
<%--													<span class="label label-danger" style="opacity: 1;"> ${taskInstance.dueDate }</span>--%>
<%--													</g:if>--%>
<%--													<g:elseif test="${DateFixedfee.minus(new Date(),taskInstance.dueDate).getDays>=1 && DateFixedfee.minus(new Date(),taskInstance.dueDate).getDays<5 }">--%>
...
<div class="col-md-12">
		...
		<div id="show-fixedfee" class="content scaffold-show" role="main">
			...
			<form class="form-horizontal">
				...
				<g:if test="${fixedfeeInstance?.yyear}">
				<div class="form-group">
					...
					<label class="col-sm-2 control-label" for="form-field-20">
						...
						<div class="col-sm-9">
												<input type="text" placeholder="text" value="${fixedfeeInstance.yyear.encodeAsHTML()}" id="form-field-21" class="form-control" disabled="disabled">
											</div>									
				...
				<g:if test="${fixedfeeInstance?.type}">
			...
			<div class="form-group">
						...
						<div class="col-sm-9">
												<input type="text" placeholder="text" value="<g:fieldValue bean="${fixedfeeInstance}" field="type.typeName"/>" id="form-field-21" class="form-control" disabled="disabled">
											</div>	
				...
				<g:if test="${fixedfeeInstance?.category}">
			<div class="form-group">
					...
					<div class="col-sm-9">
												<input type="text" placeholder="text" value="<g:fieldValue bean="${fixedfeeInstance}" field="category.categoryName"/>" id="form-field-21" class="form-control" disabled="disabled">
											</div>							
				...
				<g:if test="${fixedfeeInstance?.minCharge}">
			<div class="form-group">
					<label class="col-sm-2 control-label" for="form-field-20">
												<g:message code="fixedfee.minCharge.label" default="Minimum Charge" />
											</label>
						<div class="col-sm-9">
												<input type="text" placeholder="text" value="<g:fieldValue bean="${fixedfeeInstance}" field="minCharge"/>" id="form-field-21" class="form-control" disabled="disabled">
											</div>							
								</div>			
					
			
				</g:if>
					<g:if test="${fixedfeeInstance?.ratePa}">
			<div class="form-group">
					<label class="col-sm-2 control-label" for="form-field-20">
												<g:message code="fixedfee.ratePa.label" default="Rate Per Annum" />
											</label>
						<div class="col-sm-9">
												<input type="text" placeholder="text" value="<g:fieldValue bean="${fixedfeeInstance}" field="ratePa"/>" id="form-field-21" class="form-control" disabled="disabled">
											</div>							
								</div>			
					
			
				</g:if>
				<g:if test="${fixedfeeInstance?.dateCreated}">
				<div class="form-group">
					
					<label class="col-sm-2 control-label" for="form-field-20">
												<g:message code="fixedfee.datecreated.label" default="Date Created" />
											</label>
						<div class="col-sm-9">
												<input type="text" placeholder="text" value="<g:formatDate date="${fixedfeeInstance?.dateCreated}" />" id="form-field-21" class="form-control" disabled="disabled">
											</div>							
				...
				<g:if test="${fixedfeeInstance?.metro}">
				
					<div class="form-group">
					<label class="col-sm-2 control-label" for="form-field-20">
											<g:message code="fixedfee.metro.label" default="Metro" />
											</label>
					<div class="col-sm-9">
						<input type="text" placeholder="text" value="<g:fieldValue bean="${fixedfeeInstance.metro}" field="metro"/>" id="form-field-21" class="form-control" disabled="disabled">
					</div>	
											
<%--						<span class="property-value" aria-labelledby="updatedByUser-label"><g:link controller="muser" action="show" id="${fixedfeeInstance?.updatedByUser?.id}">${fixedfeeInstance?.updatedByUser?.encodeAsHTML()}</g:link></span>--%>
					
					</div>
				</g:if>
			
			</form>
			<g:form url="[resource:fixedfeeInstance, action:'delete']" method="DELETE">
				<fieldset class="buttons">
					<g:link class="btn btn-primary" action="edit" resource="${fixedfeeInstance}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
