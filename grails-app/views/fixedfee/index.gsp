...
<%--											Add Item</a>--%>
		...
		<div id="list-fixedfee" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						<g:sortableColumn property="fixedfee" title="${message(code: 'fixedfee.id.label', default: 'ID')}" />
						<g:sortableColumn property="fixedfee" title="${message(code: 'fixedfee.yyear.label', default: 'Year')}" />
						
						<g:sortableColumn property="organizationType" title="${message(code: 'fixedfee.type.label', default: 'Type')}" />
					
						<g:sortableColumn property="enquires" title="${message(code: 'fixedfee.category.label', default: 'Category')}" />
						<g:sortableColumn property="region" title="${message(code: 'fixedfee.minCharge.label', default: 'Minimum Charge')}" />					
						<g:sortableColumn property="city" title="${message(code: 'fixedfee.ratePa.label', default: 'Imposed Rate')}" />
						<th>Operation</th>
					
					</tr>
				</thead>
				<tbody>
				<g:each in="${fixedfees}" status="i" var="fixedfeeInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
					
						<td><g:link action="show" id="${fixedfeeInstance.id}">${fieldValue(bean: fixedfeeInstance, field: "id")}</g:link></td>
					
						<td>${fixedfeeInstance.yyear.encodeAsHTML()}</td>
					
						<td>${fieldValue(bean: fixedfeeInstance, field: "type.typeName")}</td>
					
						<td>${fieldValue(bean: fixedfeeInstance, field: "category.categoryName")}</td>
						
						<td>${fieldValue(bean: fixedfeeInstance, field: "minCharge")}</td>
						
						<td>${fieldValue(bean: fixedfeeInstance, field: "ratePa")}</td>


									<td>
														<div class="visible-md visible-lg hidden-sm hidden-xs">

													<g:link class="btn btn-xs btn-teal tooltips" data-placement="top" data-original-title="Edit" action="edit" resource="${fixedfeeInstance}">
															<i class="fa fa-edit"></i></g:link>
												<sec:ifAnyGranted roles="ROLE_ADMIN,ROLE_SUPERVISOR">			
													<g:link class="btn btn-xs btn-bricky tooltips" data-placement="top" data-original-title="Remove" action="delete" resource="${fixedfeeInstance}">
												...
												<div class="visible-xs visible-sm hidden-md hidden-lg">
													<div class="btn-group">
														...
														<ul role="menu" class="dropdown-menu pull-right">
															...
															<g:link role="menuitem" tabindex="-1" action="edit" resource="${fixedfeeInstance}">
															...
															<sec:ifAnyGranted roles="ROLE_ADMIN,ROLE_SUPERVISOR">
																<li role="presentation">
																	...
																	<g:link role="menuitem" tabindex="-1" action="delete" resource="${fixedfeeInstance}">
...
<%--				<g:paginate total="${fixedfeeInstanceCount ?: 0}" />--%>
<%--			</div>--%>
		<!-- end: PAGE CONTENT-->
				</div>
			</div>
