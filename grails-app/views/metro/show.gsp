...
<html>
	<head>
<g:set var="entityName" value="${message(code: 'metro.label', default: 'Metro')}" />
...
<%--													<g:if test="${DateMetro.minus(new Date(),taskInstance.dueDate).getDays<1 }">--%>
<%--													<span class="label label-danger" style="opacity: 1;"> ${taskInstance.dueDate }</span>--%>
<%--													</g:if>--%>
<%--													<g:elseif test="${DateMetro.minus(new Date(),taskInstance.dueDate).getDays>=1 && DateMetro.minus(new Date(),taskInstance.dueDate).getDays<5 }">--%>
...
<div class="col-md-12">
		...
		<div id="show-metro" class="content scaffold-show" role="main">

			<g:if test="${flash.message}">
			<div class="alert alert-danger">${flash.message}</div>
			</g:if>
			<form class="form-horizontal">
							<g:if test="${metroInstance?.metro}">
			...
			<div class="form-group">
						...
						<div class="col-sm-9">
												<input type="text" placeholder="text" value="<g:fieldValue bean="${metroInstance}" field="metro"/>" id="form-field-21" class="form-control" disabled="disabled">
											</div>	
				...
				<div class="form-group">
					...
					<label class="col-sm-2 control-label" for="form-field-20">
						...
						<div class="col-sm-9">
												<input type="text" placeholder="text" value="<g:fieldValue bean="${metroInstance}" field="city"/>" id="form-field-21" class="form-control" disabled="disabled">
											</div>									
				...
				<g:if test="${metroInstance?.region}">
			<div class="form-group">
					...
					<div class="col-sm-9">
												<input type="text" placeholder="text" value="<g:fieldValue bean="${metroInstance}" field="region"/>" id="form-field-21" class="form-control" disabled="disabled">
											</div>							
				...
				<g:if test="${metroInstance?.organizationType}">
			<div class="form-group">
					<label class="col-sm-2 control-label" for="form-field-20">
												<g:message code="metro.organizationType.label" default="Organization Type" />
											</label>
						<div class="col-sm-9">
												<input type="text" placeholder="text" value="<g:fieldValue bean="${metroInstance}" field="organizationType"/>" id="form-field-21" class="form-control" disabled="disabled">
											</div>							
								</div>			
					...
					<g:if test="${metroInstance?.cordinatorsNumbers}">
			<div class="form-group">
					<label class="col-sm-2 control-label" for="form-field-20">
												<g:message code="metro.cordinatorsNumbers.label" default="Cordinator's Number" />
											</label>
						<div class="col-sm-9">
												<input type="text" placeholder="text" value="<g:fieldValue bean="${metroInstance}" field="cordinatorsNumbers"/>" id="form-field-21" class="form-control" disabled="disabled">
											</div>							
								</div>			
				...
				<g:if test="${metroInstance?.enquires}">
				<div class="form-group">
					...
					<label class="col-sm-2 control-label" for="form-field-20">
						...
						<div class="col-sm-9">
												<input type="text" placeholder="text" value="<g:fieldValue bean="${metroInstance}" field="enquires"/>" id="form-field-21" class="form-control" disabled="disabled">
											</div>							
				...
				<g:if test="${metroInstance?.submetro}">
					<div class="form-group">
					
					<label class="col-sm-2 control-label" for="form-field-20">
											<g:message code="metro.submetro.label" default="Submetro" />
											</label>
					<div class="col-sm-9">
												<input type="text" placeholder="text" value="<g:fieldValue bean="${metroInstance}" field="submetro"/>" id="form-field-21" class="form-control" disabled="disabled">
											</div>							
					</div>	
				...
				<g:if test="${metroInstance?.electoralArea}">
					<div class="form-group">
					
					<label class="col-sm-2 control-label" for="form-field-20">
											<g:message code="metro.electoralArea.label" default="Electoral Area" />
											</label>
					<div class="col-sm-9">
												<input type="text" placeholder="text" value="<g:fieldValue bean="${metroInstance}" field="electoralArea"/>" id="form-field-21" class="form-control" disabled="disabled">
											</div>							
					</div>	
					...
					<g:if test="${metroInstance?.businessNotice}">
					<div class="form-group">
					...
					<div class="col-sm-9">
												<textarea placeholder="Default Text" id="businessNotice" class="form-control" disabled="disabled"><g:fieldValue bean="${metroInstance}" field="businessNotice"/></textarea>
											</div>							
					</div>	
				...
				<g:if test="${metroInstance?.propertyNotice}">
					<div class="form-group">
					
					<label class="col-sm-2 control-label" for="form-field-20">
											<g:message code="metro.propertyNotice.label" default="Property Notice" />
											</label>
							<div class="col-sm-9">
								<textarea placeholder="Default Text" id="propertyNotice" class="form-control" disabled="disabled"><g:fieldValue bean="${metroInstance}" field="propertyNotice"/></textarea>
				...
				<g:if test="${metroInstance?.billMsg}">
					<div class="form-group">
					
					<label class="col-sm-2 control-label" for="form-field-20">
											<g:message code="metro.billMsg.label" default="Bill Message" />
											</label>
							<div class="col-sm-9">
								<textarea placeholder="Default Text" id="billMsg" class="form-control" disabled="disabled"><g:fieldValue bean="${metroInstance}" field="billMsg"/></textarea>
				...
				<g:if test="${metroInstance?.paymentNotification}">
					<div class="form-group">
					...
					<label class="col-sm-2 control-label" for="form-field-20">
							...
							<div class="col-sm-9">
								<textarea placeholder="Default Text" id="billMsg" class="form-control" disabled="disabled"><g:fieldValue bean="${metroInstance}" field="paymentNotification"/></textarea>
				...
				<g:if test="${metroInstance?.fixedfees}">
				
					<span id="fixedfees-label" class="property-label"><g:message code="metro.fixedfees.label" default="Fixedfees" /></span>
				...
				--%><g:if test="${metroInstance?.logo}">
				<div class="form-group">
				
					<label class="col-sm-2 control-label" for="form-field-20">
											<g:message code="metro.metro.label" default="Metro" />
											</label>
					<div class="col-sm-9">
									<div id="preview-pane">
										<div class="preview-container">
											<img src="${resource(dir: 'images/logos', file: '${metroInstance.logo}')}" class="jcrop-preview" alt="Preview" />
										</div>
									</div>
					</div>	
				...
				<g:if test="${metroInstance?.signature}">
				<div class="form-group">
				
					<label class="col-sm-2 control-label" for="form-field-20">
											<g:message code="metro.signature.label" default="Signature" />
											</label>
					<div class="col-sm-9">
									<div id="preview-pane">
										<div class="preview-container">
											<img src="${resource(dir: 'images/signature', file: '${metroInstance.signature}')}" class="jcrop-preview" alt="Preview" />
										</div>
									</div>
					</div>	
					
<%--						<span class="property-value" aria-labelledby="type-label"><g:link controller="eventtype" action="show" id="${metroInstance?.type?.id}">${metroInstance?.type?.typeName.encodeAsHTML()}</g:link></span>--%>
			...
			<g:form url="[resource:metroInstance, action:'delete']" method="DELETE">
				<fieldset class="buttons">
					<g:link class="btn btn-primary" action="edit" resource="${metroInstance}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
