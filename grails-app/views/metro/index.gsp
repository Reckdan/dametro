		...
		<div id="list-category" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="minCharge" title="${message(code: 'category.minCharge.label', default: 'Min Charge')}" />
					
						<g:sortableColumn property="gcatId" title="${message(code: 'category.gcatId.label', default: 'Gcat Id')}" />
					
						<g:sortableColumn property="datecreated" title="${message(code: 'category.datecreated.label', default: 'Datecreated')}" />
					
						<g:sortableColumn property="dateupdated" title="${message(code: 'category.dateupdated.label', default: 'Dateupdated')}" />
						<th>Operation</th>
				...
				<g:each in="${categories}" status="i" var="categoryInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:formatDate date="${categoryInstance.dateupdated}" /></td>
									<td>
