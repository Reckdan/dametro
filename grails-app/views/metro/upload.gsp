...
<div class="col-md-12">
		...
		<div id="create-metro" class="content scaffold-create" role="main">
			...
			<ul class="errors" role="alert">
				<g:eachError bean="${metroInstance}" var="error">
			...
			<g:form url="[controller:'metro', action:'upload']" class="form-horizontal" enctype="multipart/form-data" >
				<fieldset class="form">
					<g:render template="uploadform"/>
				</fieldset>
				<fieldset class="buttons">
					<g:submitButton name="upload" class="btn btn-primary" value="${message(code: 'default.button.upload.label', default: 'Upload')}" />
				</fieldset>
			</g:form>
		</div>
