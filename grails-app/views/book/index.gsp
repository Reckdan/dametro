...
<%--											Add Item</a>--%>
		...
		<div id="list-book" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						<g:sortableColumn property="startSerial" title="${message(code: 'book.serialrange.label', default: 'Serail Range')}" />
						<g:sortableColumn property="startSerial" title="${message(code: 'book.startSerial.label', default: 'Start Serial')}" />
					
						<g:sortableColumn property="endSerial" title="${message(code: 'book.endSerial.label', default: 'End Serial')}" />
					
						<g:sortableColumn property="voucherNo" title="${message(code: 'book.voucherNo.label', default: 'Voucher No')}" />
					
						<g:sortableColumn property="date" title="${message(code: 'book.date.label', default: 'Date')}" />
					
						<th><g:message code="book.metro.label" default="Metro" /></th>
				...
				<g:each in="${books}" status="i" var="bookInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${bookInstance.id}">${fieldValue(bean: bookInstance, field: "serialrange")}</g:link></td>
						<td>${bookInstance.startSerial.encodeAsHTML()}</td>
						<td>${bookInstance.endSerial.encodeAsHTML()} </td>
					
						<td>${fieldValue(bean: bookInstance, field: "voucherNo")}</td>
					
						<td><g:formatDate date="${bookInstance.date}" /></td>
					
						<td>${fieldValue(bean: bookInstance, field: "metro.metro")}</td>
					
						<td>${fieldValue(bean: bookInstance, field: "quantity")}</td>
					
						<td><div class="visible-md visible-lg hidden-sm hidden-xs">

													<g:link class="btn btn-xs btn-teal tooltips" data-placement="top" data-original-title="Edit" action="edit" resource="${bookInstance}">
															<i class="fa fa-edit"></i></g:link>
												<sec:ifAnyGranted roles="ROLE_ADMIN,ROLE_SUPERVISOR">			
													<g:link class="btn btn-xs btn-bricky tooltips" data-placement="top" data-original-title="Remove" action="delete" resource="${bookInstance}">
												...
												<div class="visible-xs visible-sm hidden-md hidden-lg">
													<div class="btn-group">
														...
														<ul role="menu" class="dropdown-menu pull-right">
															...
															<g:link role="menuitem" tabindex="-1" action="edit" resource="${bookInstance}">
															...
															<sec:ifAnyGranted roles="ROLE_ADMIN,ROLE_SUPERVISOR">
																<li role="presentation">
																	...
																	<g:link role="menuitem" tabindex="-1" action="delete" resource="${bookInstance}">
