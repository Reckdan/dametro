...
<%--													<g:if test="${DateBook.minus(new Date(),taskInstance.dueDate).getDays<1 }">--%>
<%--													<span class="label label-danger" style="opacity: 1;"> ${taskInstance.dueDate }</span>--%>
<%--													</g:if>--%>
<%--													<g:elseif test="${DateBook.minus(new Date(),taskInstance.dueDate).getDays>=1 && DateBook.minus(new Date(),taskInstance.dueDate).getDays<5 }">--%>
...
<%--													<g:else><span class="label label-info" style="opacity: 1;"> ${taskInstance.dueDate }</span></g:else>--%>
		...
		<div class="main-container">
			...
			<g:form url="[resource:bookInstance, action:'update']" method="PUT" class="form-horizontal" >
