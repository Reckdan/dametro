...
<div class="col-md-12">
			...
			<form class="form-horizontal">
				...
				<g:if test="${bookInstance?.startSerial}">
				<div class="form-group">
					<label class="col-sm-2 control-label" for="startSerial"><g:message code="book.startSerial.label" default="Start Serial" /></label>
					<div class="col-sm-9">
					 <input type="text" placeholder="text" value="<g:fieldValue bean="${bookInstance}" field="startSerial"/>" name="startSerial" class="form-control" disabled="disabled">
				...
				<g:if test="${bookInstance?.endSerial}">
				<div class="form-group">
					<label class="col-sm-2 control-label" for="endSerial"><g:message code="book.endSerial.label" default="End Serial" /></label>
					<div class="col-sm-9">
					 <input type="text" placeholder="text" value="<g:fieldValue bean="${bookInstance}" field="endSerial"/>" name="endSerial" class="form-control" disabled="disabled">
				...
				<g:if test="${bookInstance?.voucherNo}">
				<div class="form-group">
					<label class="col-sm-2 control-label" for="voucherNo"><g:message code="book.voucherNo.label" default="Voucher No" /></label>
					<div class="col-sm-9">
					 <input type="text" placeholder="text" value="<g:fieldValue bean="${bookInstance}" field="voucherNo"/>" id="form-field-21" class="form-control" disabled="disabled">
				...
				<div class="form-group">
					<label class="col-sm-2 control-label" for="date"><g:message code="book.date.label" default="Date" /></label>
					<div class="col-sm-9">
					 <input type="text" placeholder="text" value="<g:formatDate date="${bookInstance?.date}" />" id="form-field-21" class="form-control" disabled="disabled">
				...
				<g:if test="${bookInstance?.metro}">
				<div class="form-group">
					<label class="col-sm-2 control-label" for="date"><g:message code="book.metro.label" default="Metro" /></label>
					<div class="col-sm-9">
					 <input type="text" placeholder="text" value="<g:fieldValue bean="${bookInstance?.metro}" field="metro"/>" id="form-field-21" class="form-control" disabled="disabled">
				...
				<div class="form-group">
					<label class="col-sm-2 control-label" for="quantity"><g:message code="book.quantity.label" default="Quantity" /></label>
					<div class="col-sm-9">
					 <input type="text" placeholder="text" value="<g:fieldValue bean="${bookInstance}" field="quantity"/>" name="quantity" class="form-control" disabled="disabled">
				...
				<g:if test="${bookInstance?.serialrange}">
				<div class="form-group">
					<label class="col-sm-2 control-label" for="serialrange"><g:message code="book.serialrange.label" default="Serialrange" /></label>
					<div class="col-sm-9">
					 <input type="text" placeholder="text" value="<g:fieldValue bean="${bookInstance}" field="serialrange"/>" name="serialrange" class="form-control" disabled="disabled">
				...
				<div class="form-group">
					<label class="col-sm-2 control-label" for="type"><g:message code="book.type.label" default="Type" /></label>
						<div class="col-sm-9">
					 <input type="text" placeholder="text" value="<g:fieldValue bean="${bookInstance?.type}" field="label"/>" name="type" class="form-control" disabled="disabled">
			...
			<g:form url="[resource:bookInstance, action:'delete']" method="DELETE">
				<fieldset class="buttons">
					<g:link class="btn btn-dark-grey" action="edit" resource="${bookInstance}"><i class="fa fa-edit"></i><g:message code="default.button.edit.label" default="Edit" /></g:link>
