...
<%--													<g:if test="${DateLocation.minus(new Date(),taskInstance.dueDate).getDays<1 }">--%>
<%--													<span class="label label-danger" style="opacity: 1;"> ${taskInstance.dueDate }</span>--%>
<%--													</g:if>--%>
<%--													<g:elseif test="${DateLocation.minus(new Date(),taskInstance.dueDate).getDays>=1 && DateLocation.minus(new Date(),taskInstance.dueDate).getDays<5 }">--%>
...
<div class="col-md-12">
		...
		<div id="show-location" class="content scaffold-show" role="main">
			...
			<form class="form-horizontal">
				...
				<div class="form-group">
					...
					<label class="col-sm-2 control-label" for="form-field-20">
						...
						<div class="col-sm-9">
												<input type="text" placeholder="text" value="<g:fieldValue bean="${locationInstance}" field="code"/>" id="form-field-21" class="form-control" disabled="disabled">
											</div>									
			...
			<div class="form-group">
						...
						<div class="col-sm-9">
												<input type="text" placeholder="text" value="<g:fieldValue bean="${locationInstance}" field="locationName"/>" id="form-field-21" class="form-control" disabled="disabled">
											</div>	
				...
				<g:if test="${locationInstance?.minCharge}">
			<div class="form-group">
					
					<label class="col-sm-2 control-label" for="form-field-20">
												<g:message code="location.minCharge.label" default="Min Charge" />
											</label>
					<div class="col-sm-9">
												<input type="text" placeholder="text" value="<g:fieldValue bean="${locationInstance}" field="minCharge"/>" id="form-field-21" class="form-control" disabled="disabled">
											</div>							
				...
				<g:if test="${locationInstance?.gcatId}">
			<div class="form-group">
					<label class="col-sm-2 control-label" for="form-field-20">
												<g:message code="location.gcatId.label" default="Gcat Id" />
											</label>
						<div class="col-sm-9">
												<input type="text" placeholder="text" value="<g:fieldValue bean="${locationInstance}" field="gcatId"/>" id="form-field-21" class="form-control" disabled="disabled">
											</div>							
								</div>			
				...
				<div class="form-group">
					...
					<label class="col-sm-2 control-label" for="form-field-20">
												<g:message code="location.datecreated.label" default="Datecreated" />
											</label>
						<div class="col-sm-9">
												<input type="text" placeholder="text" value="<g:formatDate date="${locationInstance?.datecreated}" />" id="form-field-21" class="form-control" disabled="disabled">
											</div>							
				...
				<g:if test="${locationInstance?.dateupdated}">
					<div class="form-group">
					
					<label class="col-sm-2 control-label" for="form-field-20">
											<g:message code="location.dateupdated.label" default="Dateupdated" />
											</label>
					<div class="col-sm-9">
												<input type="text" placeholder="text" value="<g:formatDate date="${locationInstance?.dateupdated}" />" id="form-field-21" class="form-control" disabled="disabled">
											</div>							
					</div>	
				...
				<g:if test="${locationInstance?.createdByUser}">
				<div class="form-group">
					
					<label class="col-sm-2 control-label" for="form-field-20">
											<g:message code="location.createdByUser.label" default="Created By User" />
											</label>
					<div class="col-sm-9">
						<input type="text" placeholder="text" value="<g:fieldValue bean="${locationInstance?.createdByUser}" field="username"/>" id="form-field-21" class="form-control" disabled="disabled">
					</div>	
<%--						<span class="property-value" aria-labelledby="createdByUser-label"><g:link controller="muser" action="show" id="${locationInstance?.createdByUser?.id}">${locationInstance?.createdByUser?.encodeAsHTML()}</g:link></span>--%>
				</div>	
				
				</g:if><%--
			
				<g:if test="${locationInstance?.fixedfees}">
				
					<span id="fixedfees-label" class="property-label"><g:message code="location.fixedfees.label" default="Fixedfees" /></span>
					
						<g:each in="${locationInstance.fixedfees}" var="f">
				...
				--%><g:if test="${locationInstance?.metro}">
				<div class="form-group">
				
					<label class="col-sm-2 control-label" for="form-field-20">
											<g:message code="location.metro.label" default="Metro" />
											</label>
					<div class="col-sm-9">
						<input type="text" placeholder="text" value="<g:fieldValue bean="${locationInstance.metro}" field="metro"/>" id="form-field-21" class="form-control" disabled="disabled">
					</div>	
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" placeholder="text" value="<g:fieldValue bean="${locationInstance.type}" field="typeName"/>" id="form-field-21" class="form-control" disabled="disabled">
					</div>	
					
<%--						<span class="property-value" aria-labelledby="type-label"><g:link controller="eventtype" action="show" id="${locationInstance?.type?.id}">${locationInstance?.type?.typeName.encodeAsHTML()}</g:link></span>--%>
					
				</div>
				</g:if>
			
				<g:if test="${locationInstance?.updatedByUser}">
				
					<div class="form-group">
					<label class="col-sm-2 control-label" for="form-field-20">
											<g:message code="location.updatedByUser.label" default="Updated By User" />
											</label>
					<div class="col-sm-9">
						<input type="text" placeholder="text" value="<g:fieldValue bean="${locationInstance.updatedByUser}" field="username"/>" id="form-field-21" class="form-control" disabled="disabled">
					</div>	
											
<%--						<span class="property-value" aria-labelledby="updatedByUser-label"><g:link controller="muser" action="show" id="${locationInstance?.updatedByUser?.id}">${locationInstance?.updatedByUser?.encodeAsHTML()}</g:link></span>--%>
