		...
		<div id="list-location" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="location" title="${message(code: 'location.location.label', default: 'Metro Name')}" />
					
						<g:sortableColumn property="city" title="${message(code: 'location.city.label', default: 'City')}" />
					
						<g:sortableColumn property="region" title="${message(code: 'location.region.label', default: 'Region')}" />
					
						<g:sortableColumn property="organizationType" title="${message(code: 'location.organizationType.label', default: 'Organization Type')}" />
					
						<g:sortableColumn property="enquires" title="${message(code: 'location.enquires.label', default: 'Enquires')}" />
					
						<g:sortableColumn property="sublocation" title="${message(code: 'location.sublocation.label', default: 'Sublocation')}" />
						<g:sortableColumn property="electoralArea" title="${message(code: 'location.electoralArea.label', default: 'Electoral Area')}" />
						<th>Operation</th>
				...
				<g:each in="${locations}" status="i" var="locationInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: locationInstance, field: "region")}</td>
					
						<td>${fieldValue(bean: locationInstance, field: "organizationType")}</td>
						
						<td>${fieldValue(bean: locationInstance, field: "enquires")}</td>
						
						<td>${fieldValue(bean: locationInstance, field: "sublocation")}</td>
						<td>${fieldValue(bean: locationInstance, field: "electoralArea")}</td>

									<td>
														<div class="visible-md visible-lg hidden-sm hidden-xs">

													<g:link class="btn btn-xs btn-teal tooltips" data-placement="top" data-original-title="Edit" action="edit" resource="${locationInstance}">
															<i class="fa fa-edit"></i></g:link>
												<sec:ifAnyGranted roles="ROLE_ADMIN,ROLE_SUPERVISOR">			
													<g:link class="btn btn-xs btn-bricky tooltips" data-placement="top" data-original-title="Remove" action="delete" resource="${locationInstance}">
												...
												<div class="visible-xs visible-sm hidden-md hidden-lg">
													<div class="btn-group">
														...
														<ul role="menu" class="dropdown-menu pull-right">
															...
															<g:link role="menuitem" tabindex="-1" action="edit" resource="${locationInstance}">
															...
															<sec:ifAnyGranted roles="ROLE_ADMIN,ROLE_SUPERVISOR">
																<li role="presentation">
																	...
																	<g:link role="menuitem" tabindex="-1" action="delete" resource="${locationInstance}">
