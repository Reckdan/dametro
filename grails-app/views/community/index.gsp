		...
		<div id="list-community" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="community" title="${message(code: 'community.communityName.label', default: 'Community Name')}" />
					
						<g:sortableColumn property="city" title="${message(code: 'community.submetro.label', default: 'Sub Metro')}" />
				...
				<tbody>
				<g:each in="${communitys}" status="i" var="communityInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
					
						<td><g:link action="show" id="${communityInstance.id}">${fieldValue(bean: communityInstance, field: "communityName")}</g:link></td>
					
						<td>${fieldValue(bean: communityInstance, field: "submetro.submetroName")}</td>
									...
									<td>
													...
													<g:link class="btn btn-xs btn-teal tooltips" data-placement="top" data-original-title="Edit" action="edit" resource="${communityInstance}">
															<i class="fa fa-edit"></i></g:link>
												<sec:ifAnyGranted roles="ROLE_ADMIN,ROLE_SUPERVISOR">			
													<g:link class="btn btn-xs btn-bricky tooltips" data-placement="top" data-original-title="Remove" action="delete" resource="${communityInstance}">
												...
												<div class="visible-xs visible-sm hidden-md hidden-lg">
													<div class="btn-group">
														...
														<ul role="menu" class="dropdown-menu pull-right">
															...
															<g:link role="menuitem" tabindex="-1" action="edit" resource="${communityInstance}">
															...
															<sec:ifAnyGranted roles="ROLE_ADMIN,ROLE_SUPERVISOR">
																<li role="presentation">
																	...
																	<g:link role="menuitem" tabindex="-1" action="delete" resource="${communityInstance}">
