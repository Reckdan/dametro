...
<%--													<g:if test="${DateCommunity.minus(new Date(),taskInstance.dueDate).getDays<1 }">--%>
<%--													<span class="label label-danger" style="opacity: 1;"> ${taskInstance.dueDate }</span>--%>
<%--													</g:if>--%>
<%--													<g:elseif test="${DateCommunity.minus(new Date(),taskInstance.dueDate).getDays>=1 && DateCommunity.minus(new Date(),taskInstance.dueDate).getDays<5 }">--%>
...
<div class="col-md-12">
		...
		<div id="show-community" class="content scaffold-show" role="main">
			...
			<div class="alert alert-danger">${flash.message}</div>
				...
				<div class="form-group">
					...
					<label class="col-sm-2 control-label" for="form-field-20">
												<g:message code="community.code.label" default="Code" />
											</label>
						
						<div class="col-sm-9">
												<input type="text" placeholder="text" value="<g:fieldValue bean="${communityInstance}" field="code"/>" id="form-field-21" class="form-control" disabled="disabled">
											</div>									
				...
				<g:if test="${communityInstance?.communityName}">
			...
			<div class="form-group">
						...
						<div class="col-sm-9">
												<input type="text" placeholder="text" value="<g:fieldValue bean="${communityInstance}" field="communityName"/>" id="form-field-21" class="form-control" disabled="disabled">
											</div>	
				...
				<g:if test="${communityInstance?.submetro}">
			<div class="form-group">
					...
					<div class="col-sm-9">
												<input type="text" placeholder="text" value="<g:fieldValue bean="${communityInstance}" field="submetro"/>" id="form-field-21" class="form-control" disabled="disabled">
											</div>							
				...
				<g:if test="${communityInstance?.dateCreated}">
				<div class="form-group">
					
					<label class="col-sm-2 control-label" for="form-field-20">
												<g:message code="community.datecreated.label" default="Date Created" />
											</label>
						<div class="col-sm-9">
												<input type="text" placeholder="text" value="<g:formatDate date="${communityInstance?.dateCreated}" />" id="form-field-21" class="form-control" disabled="disabled">
											</div>							
				...
				<g:if test="${communityInstance?.dateUpdated}">
					<div class="form-group">
					
					<label class="col-sm-2 control-label" for="form-field-20">
											<g:message code="community.dateUpdated.label" default="Date Updated" />
											</label>
					<div class="col-sm-9">
												<input type="text" placeholder="text" value="<g:formatDate date="${communityInstance?.dateUpdated}" />" id="form-field-21" class="form-control" disabled="disabled">
											</div>							
					</div>	
				...
				<g:if test="${communityInstance?.createdByUser}">
				<div class="form-group">
					
					<label class="col-sm-2 control-label" for="form-field-20">
											<g:message code="community.createdByUser.label" default="Created By User" />
											</label>
					<div class="col-sm-9">
						<input type="text" placeholder="text" value="<g:fieldValue bean="${communityInstance?.createdByUser}" field="username"/>" id="form-field-21" class="form-control" disabled="disabled">
					</div>	
<%--						<span class="property-value" aria-labelledby="createdByUser-label"><g:link controller="muser" action="show" id="${communityInstance?.createdByUser?.id}">${communityInstance?.createdByUser?.encodeAsHTML()}</g:link></span>--%>
				</div>	
				
				</g:if>
			
				<g:if test="${communityInstance?.updatedByUser}">
				
					<div class="form-group">
					<label class="col-sm-2 control-label" for="form-field-20">
											<g:message code="community.updatedByUser.label" default="Updated By User" />
											</label>
					<div class="col-sm-9">
						<input type="text" placeholder="text" value="<g:fieldValue bean="${communityInstance.updatedByUser}" field="username"/>" id="form-field-21" class="form-control" disabled="disabled">
					</div>	
											
<%--						<span class="property-value" aria-labelledby="updatedByUser-label"><g:link controller="muser" action="show" id="${communityInstance?.updatedByUser?.id}">${communityInstance?.updatedByUser?.encodeAsHTML()}</g:link></span>--%>
			...
			<g:form url="[resource:communityInstance, action:'delete']" method="DELETE">
				<fieldset class="buttons">
					<g:link class="btn btn-primary" action="edit" resource="${communityInstance}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
