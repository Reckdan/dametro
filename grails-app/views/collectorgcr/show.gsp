...
<html>
	<head>
<g:set var="entityName" value="${message(code: 'collectorgcr.label', default: 'Collectorgcr')}" />
...
<%--													<g:if test="${DateCollectorgcr.minus(new Date(),taskInstance.dueDate).getDays<1 }">--%>
<%--													<span class="label label-danger" style="opacity: 1;"> ${taskInstance.dueDate }</span>--%>
<%--													</g:if>--%>
<%--													<g:elseif test="${DateCollectorgcr.minus(new Date(),taskInstance.dueDate).getDays>=1 && DateCollectorgcr.minus(new Date(),taskInstance.dueDate).getDays<5 }">--%>
...
<div class="col-md-12">
		...
		<div id="show-collectorgcr" class="content scaffold-show" role="main">
			...
			<form class="form-horizontal">
				...
				<g:if test="${collectorgcrInstance?.code}">
				<div class="form-group">
					...
					<label class="col-sm-2 control-label" for="form-field-20">
						...
						<div class="col-sm-9">
												<input type="text" placeholder="text" value="<g:fieldValue bean="${collectorgcrInstance}" field="code"/>" id="form-field-21" class="form-control" disabled="disabled">
											</div>									
				...
				<g:if test="${collectorgcrInstance?.collectorgcrName}">
			...
			<div class="form-group">
						...
						<div class="col-sm-9">
												<input type="text" placeholder="text" value="<g:fieldValue bean="${collectorgcrInstance}" field="collectorgcrName"/>" id="form-field-21" class="form-control" disabled="disabled">
											</div>	
				...
				<g:if test="${collectorgcrInstance?.minCharge}">
			<div class="form-group">
					...
					<div class="col-sm-9">
												<input type="text" placeholder="text" value="<g:fieldValue bean="${collectorgcrInstance}" field="minCharge"/>" id="form-field-21" class="form-control" disabled="disabled">
											</div>							
				...
				<g:if test="${collectorgcrInstance?.gcatId}">
			<div class="form-group">
					<label class="col-sm-2 control-label" for="form-field-20">
												<g:message code="collectorgcr.gcatId.label" default="Gcat Id" />
											</label>
						<div class="col-sm-9">
												<input type="text" placeholder="text" value="<g:fieldValue bean="${collectorgcrInstance}" field="gcatId"/>" id="form-field-21" class="form-control" disabled="disabled">
											</div>							
								</div>			
				...
				<g:if test="${collectorgcrInstance?.datecreated}">
				<div class="form-group">
					...
					<label class="col-sm-2 control-label" for="form-field-20">
						...
						<div class="col-sm-9">
												<input type="text" placeholder="text" value="<g:formatDate date="${collectorgcrInstance?.datecreated}" />" id="form-field-21" class="form-control" disabled="disabled">
											</div>							
				...
				<g:if test="${collectorgcrInstance?.dateupdated}">
					<div class="form-group">
					...
					<div class="col-sm-9">
												<input type="text" placeholder="text" value="<g:formatDate date="${collectorgcrInstance?.dateupdated}" />" id="form-field-21" class="form-control" disabled="disabled">
											</div>							
					</div>	
				...
				<g:if test="${collectorgcrInstance?.createdByUser}">
				<div class="form-group">
					
					<label class="col-sm-2 control-label" for="form-field-20">
											<g:message code="collectorgcr.createdByUser.label" default="Created By User" />
											</label>
					<div class="col-sm-9">
						<input type="text" placeholder="text" value="<g:fieldValue bean="${collectorgcrInstance?.createdByUser}" field="username"/>" id="form-field-21" class="form-control" disabled="disabled">
					</div>	
<%--						<span class="property-value" aria-labelledby="createdByUser-label"><g:link controller="muser" action="show" id="${collectorgcrInstance?.createdByUser?.id}">${collectorgcrInstance?.createdByUser?.encodeAsHTML()}</g:link></span>--%>
				</div>	
				
				</g:if><%--
			
				<g:if test="${collectorgcrInstance?.fixedfees}">
				
					<span id="fixedfees-label" class="property-label"><g:message code="collectorgcr.fixedfees.label" default="Fixedfees" /></span>
				...
				--%><g:if test="${collectorgcrInstance?.metro}">
				<div class="form-group">
				
					<label class="col-sm-2 control-label" for="form-field-20">
											<g:message code="collectorgcr.metro.label" default="Metro" />
											</label>
					<div class="col-sm-9">
						<input type="text" placeholder="text" value="<g:fieldValue bean="${collectorgcrInstance.metro}" field="metro"/>" id="form-field-21" class="form-control" disabled="disabled">
					</div>	
				...
				<g:if test="${collectorgcrInstance?.type}">
				<div class="form-group">
				
					<label class="col-sm-2 control-label" for="form-field-20">
											<g:message code="collectorgcr.type.label" default="Type" />
											</label>
					<div class="col-sm-9">
						<input type="text" placeholder="text" value="<g:fieldValue bean="${collectorgcrInstance.type}" field="typeName"/>" id="form-field-21" class="form-control" disabled="disabled">
					</div>	
					
<%--						<span class="property-value" aria-labelledby="type-label"><g:link controller="eventtype" action="show" id="${collectorgcrInstance?.type?.id}">${collectorgcrInstance?.type?.typeName.encodeAsHTML()}</g:link></span>--%>
					
				</div>
				</g:if>
			
				<g:if test="${collectorgcrInstance?.updatedByUser}">
					...
					<div class="col-sm-9">
						<input type="text" placeholder="text" value="<g:fieldValue bean="${collectorgcrInstance.updatedByUser}" field="username"/>" id="form-field-21" class="form-control" disabled="disabled">
					</div>	
											
<%--						<span class="property-value" aria-labelledby="updatedByUser-label"><g:link controller="muser" action="show" id="${collectorgcrInstance?.updatedByUser?.id}">${collectorgcrInstance?.updatedByUser?.encodeAsHTML()}</g:link></span>--%>
					
					</div>
				</g:if>
			
			</form>
			<g:form url="[resource:collectorgcrInstance, action:'delete']" method="DELETE">
				<fieldset class="buttons">
					<g:link class="btn btn-primary" action="edit" resource="${collectorgcrInstance}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
