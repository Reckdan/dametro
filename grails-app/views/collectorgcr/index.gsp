...
<%--											Add Item</a>--%>
		...
		<div id="list-collectorgcr" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="collectorgcr" title="${message(code: 'collectorgcr.collectorgcr.label', default: 'Metro Name')}" />
					
						<g:sortableColumn property="city" title="${message(code: 'collectorgcr.city.label', default: 'City')}" />
					
						<g:sortableColumn property="region" title="${message(code: 'collectorgcr.region.label', default: 'Region')}" />
					
						<g:sortableColumn property="organizationType" title="${message(code: 'collectorgcr.organizationType.label', default: 'Organization Type')}" />
					
						<g:sortableColumn property="enquires" title="${message(code: 'collectorgcr.enquires.label', default: 'Enquires')}" />
					
						<g:sortableColumn property="subcollectorgcr" title="${message(code: 'collectorgcr.subcollectorgcr.label', default: 'Subcollectorgcr')}" />
						<g:sortableColumn property="electoralArea" title="${message(code: 'collectorgcr.electoralArea.label', default: 'Electoral Area')}" />
						<th>Operation</th>
					
					</tr>
				</thead>
				<tbody>
				<g:each in="${collectorgcrs}" status="i" var="collectorgcrInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
					
						<td><g:link action="show" id="${collectorgcrInstance.id}">${fieldValue(bean: collectorgcrInstance, field: "collectorgcr")}</g:link></td>
					
						<td>${fieldValue(bean: collectorgcrInstance, field: "city")}</td>
					
						<td>${fieldValue(bean: collectorgcrInstance, field: "region")}</td>
					
						<td>${fieldValue(bean: collectorgcrInstance, field: "organizationType")}</td>
						
						<td>${fieldValue(bean: collectorgcrInstance, field: "enquires")}</td>
						
						<td>${fieldValue(bean: collectorgcrInstance, field: "subcollectorgcr")}</td>
						<td>${fieldValue(bean: collectorgcrInstance, field: "electoralArea")}</td>

									<td>
														<div class="visible-md visible-lg hidden-sm hidden-xs">

													<g:link class="btn btn-xs btn-teal tooltips" data-placement="top" data-original-title="Edit" action="edit" resource="${collectorgcrInstance}">
															<i class="fa fa-edit"></i></g:link>
												<sec:ifAnyGranted roles="ROLE_ADMIN,ROLE_SUPERVISOR">			
													<g:link class="btn btn-xs btn-bricky tooltips" data-placement="top" data-original-title="Remove" action="delete" resource="${collectorgcrInstance}">
												...
												<div class="visible-xs visible-sm hidden-md hidden-lg">
													<div class="btn-group">
														...
														<ul role="menu" class="dropdown-menu pull-right">
															...
															<g:link role="menuitem" tabindex="-1" action="edit" resource="${collectorgcrInstance}">
															...
															<sec:ifAnyGranted roles="ROLE_ADMIN,ROLE_SUPERVISOR">
																<li role="presentation">
																	...
																	<g:link role="menuitem" tabindex="-1" action="delete" resource="${collectorgcrInstance}">
...
<%--				<g:paginate total="${collectorgcrInstanceCount ?: 0}" />--%>
<%--			</div>--%>
		<!-- end: PAGE CONTENT-->
				</div>
			</div>
