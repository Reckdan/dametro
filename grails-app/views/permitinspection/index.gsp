...
<%--											Add Item</a>--%>
		...
		<div id="list-permitinspection" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="permitinspection" title="${message(code: 'permitinspection.permitinspection.label', default: 'Metro Name')}" />
					
						<g:sortableColumn property="city" title="${message(code: 'permitinspection.city.label', default: 'City')}" />
					
						<g:sortableColumn property="region" title="${message(code: 'permitinspection.region.label', default: 'Region')}" />
					
						<g:sortableColumn property="organizationType" title="${message(code: 'permitinspection.organizationType.label', default: 'Organization Type')}" />
					
						<g:sortableColumn property="enquires" title="${message(code: 'permitinspection.enquires.label', default: 'Enquires')}" />
					
						<g:sortableColumn property="subpermitinspection" title="${message(code: 'permitinspection.subpermitinspection.label', default: 'Subpermitinspection')}" />
						<g:sortableColumn property="electoralArea" title="${message(code: 'permitinspection.electoralArea.label', default: 'Electoral Area')}" />
						<th>Operation</th>
					
					</tr>
				</thead>
				<tbody>
				<g:each in="${permitinspections}" status="i" var="permitinspectionInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
					
						<td><g:link action="show" id="${permitinspectionInstance.id}">${fieldValue(bean: permitinspectionInstance, field: "permitinspection")}</g:link></td>
					
						<td>${fieldValue(bean: permitinspectionInstance, field: "city")}</td>
					
						<td>${fieldValue(bean: permitinspectionInstance, field: "region")}</td>
					
						<td>${fieldValue(bean: permitinspectionInstance, field: "organizationType")}</td>
						
						<td>${fieldValue(bean: permitinspectionInstance, field: "enquires")}</td>
						
						<td>${fieldValue(bean: permitinspectionInstance, field: "subpermitinspection")}</td>
						<td>${fieldValue(bean: permitinspectionInstance, field: "electoralArea")}</td>

									<td>
														<div class="visible-md visible-lg hidden-sm hidden-xs">

													<g:link class="btn btn-xs btn-teal tooltips" data-placement="top" data-original-title="Edit" action="edit" resource="${permitinspectionInstance}">
															<i class="fa fa-edit"></i></g:link>
												<sec:ifAnyGranted roles="ROLE_ADMIN,ROLE_SUPERVISOR">			
													<g:link class="btn btn-xs btn-bricky tooltips" data-placement="top" data-original-title="Remove" action="delete" resource="${permitinspectionInstance}">
												...
												<div class="visible-xs visible-sm hidden-md hidden-lg">
													<div class="btn-group">
														...
														<ul role="menu" class="dropdown-menu pull-right">
															...
															<g:link role="menuitem" tabindex="-1" action="edit" resource="${permitinspectionInstance}">
															...
															<sec:ifAnyGranted roles="ROLE_ADMIN,ROLE_SUPERVISOR">
																<li role="presentation">
																	...
																	<g:link role="menuitem" tabindex="-1" action="delete" resource="${permitinspectionInstance}">
...
<%--				<g:paginate total="${permitinspectionInstanceCount ?: 0}" />--%>
<%--			</div>--%>
		<!-- end: PAGE CONTENT-->
				</div>
			</div>
