		...
		<div id="list-document" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="document" title="${message(code: 'document.document.label', default: 'Metro Name')}" />
					
						<g:sortableColumn property="city" title="${message(code: 'document.city.label', default: 'City')}" />
					
						<g:sortableColumn property="region" title="${message(code: 'document.region.label', default: 'Region')}" />
					
						<g:sortableColumn property="organizationType" title="${message(code: 'document.organizationType.label', default: 'Organization Type')}" />
					
						<g:sortableColumn property="enquires" title="${message(code: 'document.enquires.label', default: 'Enquires')}" />
					
						<g:sortableColumn property="subdocument" title="${message(code: 'document.subdocument.label', default: 'Subdocument')}" />
						<g:sortableColumn property="electoralArea" title="${message(code: 'document.electoralArea.label', default: 'Electoral Area')}" />
						<th>Operation</th>
				...
				<g:each in="${documents}" status="i" var="documentInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${documentInstance.id}">${fieldValue(bean: documentInstance, field: "document")}</g:link></td>
					
						<td>${fieldValue(bean: documentInstance, field: "city")}</td>
					
						<td>${fieldValue(bean: documentInstance, field: "region")}</td>
					
						<td>${fieldValue(bean: documentInstance, field: "organizationType")}</td>
						
						<td>${fieldValue(bean: documentInstance, field: "enquires")}</td>
						
						<td>${fieldValue(bean: documentInstance, field: "subdocument")}</td>
						<td>${fieldValue(bean: documentInstance, field: "electoralArea")}</td>

									<td>
														<div class="visible-md visible-lg hidden-sm hidden-xs">

													<g:link class="btn btn-xs btn-teal tooltips" data-placement="top" data-original-title="Edit" action="edit" resource="${documentInstance}">
															<i class="fa fa-edit"></i></g:link>
												<sec:ifAnyGranted roles="ROLE_ADMIN,ROLE_SUPERVISOR">			
													<g:link class="btn btn-xs btn-bricky tooltips" data-placement="top" data-original-title="Remove" action="delete" resource="${documentInstance}">
												...
												<div class="visible-xs visible-sm hidden-md hidden-lg">
													<div class="btn-group">
														...
														<ul role="menu" class="dropdown-menu pull-right">
															...
															<g:link role="menuitem" tabindex="-1" action="edit" resource="${documentInstance}">
															...
															<sec:ifAnyGranted roles="ROLE_ADMIN,ROLE_SUPERVISOR">
																<li role="presentation">
																	...
																	<g:link role="menuitem" tabindex="-1" action="delete" resource="${documentInstance}">
