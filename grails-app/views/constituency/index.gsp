...
<%--											Add Item</a>--%>
		...
		<div id="list-constituency" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="constituency" title="${message(code: 'constituency.constituencyName.label', default: 'Constituency Name')}" />
					
						<g:sortableColumn property="city" title="${message(code: 'constituency.submetro.label', default: 'Sub Metro')}" />
				...
				<tbody>
				<g:each in="${constituencys}" status="i" var="constituencyInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
					
						<td><g:link action="show" id="${constituencyInstance.id}">${fieldValue(bean: constituencyInstance, field: "constituencyName")}</g:link></td>
					
						<td>${fieldValue(bean: constituencyInstance, field: "submetro.submetroName")}</td>
									...
									<td>
													...
													<g:link class="btn btn-xs btn-teal tooltips" data-placement="top" data-original-title="Edit" action="edit" resource="${constituencyInstance}">
															<i class="fa fa-edit"></i></g:link>
												<sec:ifAnyGranted roles="ROLE_ADMIN,ROLE_SUPERVISOR">			
													<g:link class="btn btn-xs btn-bricky tooltips" data-placement="top" data-original-title="Remove" action="delete" resource="${constituencyInstance}">
												...
												<div class="visible-xs visible-sm hidden-md hidden-lg">
													<div class="btn-group">
														...
														<ul role="menu" class="dropdown-menu pull-right">
															...
															<g:link role="menuitem" tabindex="-1" action="edit" resource="${constituencyInstance}">
															...
															<sec:ifAnyGranted roles="ROLE_ADMIN,ROLE_SUPERVISOR">
																<li role="presentation">
																	...
																	<g:link role="menuitem" tabindex="-1" action="delete" resource="${constituencyInstance}">
...
<%--				<g:paginate total="${constituencyInstanceCount ?: 0}" />--%>
<%--			</div>--%>
		<!-- end: PAGE CONTENT-->
				</div>
			</div>
