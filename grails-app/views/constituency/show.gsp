...
<html>
	<head>
<g:set var="entityName" value="${message(code: 'constituency.label', default: 'Constituency')}" />
...
<%--													<g:if test="${DateConstituency.minus(new Date(),taskInstance.dueDate).getDays<1 }">--%>
<%--													<span class="label label-danger" style="opacity: 1;"> ${taskInstance.dueDate }</span>--%>
<%--													</g:if>--%>
<%--													<g:elseif test="${DateConstituency.minus(new Date(),taskInstance.dueDate).getDays>=1 && DateConstituency.minus(new Date(),taskInstance.dueDate).getDays<5 }">--%>
...
<div class="col-md-12">
		...
		<div id="show-constituency" class="content scaffold-show" role="main">
			...
			<form class="form-horizontal">
				...
				<g:if test="${constituencyInstance?.code}">
				<div class="form-group">
					
					<label class="col-sm-2 control-label" for="form-field-20">
												<g:message code="constituency.code.label" default="Code" />
											</label>
						
						<div class="col-sm-9">
												<input type="text" placeholder="text" value="<g:fieldValue bean="${constituencyInstance}" field="code"/>" id="form-field-21" class="form-control" disabled="disabled">
											</div>									
				...
				<g:if test="${constituencyInstance?.constituencyName}">
			...
			<div class="form-group">
						...
						<div class="col-sm-9">
												<input type="text" placeholder="text" value="<g:fieldValue bean="${constituencyInstance}" field="constituencyName"/>" id="form-field-21" class="form-control" disabled="disabled">
											</div>	
				...
				<g:if test="${constituencyInstance?.submetro}">
			<div class="form-group">
					...
					<div class="col-sm-9">
												<input type="text" placeholder="text" value="<g:fieldValue bean="${constituencyInstance}" field="submetro"/>" id="form-field-21" class="form-control" disabled="disabled">
											</div>							
				...
				<g:if test="${constituencyInstance?.dateCreated}">
				<div class="form-group">
					
					<label class="col-sm-2 control-label" for="form-field-20">
												<g:message code="constituency.datecreated.label" default="Date Created" />
											</label>
						<div class="col-sm-9">
												<input type="text" placeholder="text" value="<g:formatDate date="${constituencyInstance?.dateCreated}" />" id="form-field-21" class="form-control" disabled="disabled">
											</div>							
				...
				<g:if test="${constituencyInstance?.dateUpdated}">
					<div class="form-group">
					
					<label class="col-sm-2 control-label" for="form-field-20">
											<g:message code="constituency.dateUpdated.label" default="Date Updated" />
											</label>
					<div class="col-sm-9">
												<input type="text" placeholder="text" value="<g:formatDate date="${constituencyInstance?.dateUpdated}" />" id="form-field-21" class="form-control" disabled="disabled">
											</div>							
					</div>	
				...
				<g:if test="${constituencyInstance?.createdByUser}">
				<div class="form-group">
					
					<label class="col-sm-2 control-label" for="form-field-20">
											<g:message code="constituency.createdByUser.label" default="Created By User" />
											</label>
					<div class="col-sm-9">
						<input type="text" placeholder="text" value="<g:fieldValue bean="${constituencyInstance?.createdByUser}" field="username"/>" id="form-field-21" class="form-control" disabled="disabled">
					</div>	
<%--						<span class="property-value" aria-labelledby="createdByUser-label"><g:link controller="muser" action="show" id="${constituencyInstance?.createdByUser?.id}">${constituencyInstance?.createdByUser?.encodeAsHTML()}</g:link></span>--%>
				</div>	
				
				</g:if>
			
				<g:if test="${constituencyInstance?.updatedByUser}">
				
					<div class="form-group">
					<label class="col-sm-2 control-label" for="form-field-20">
											<g:message code="constituency.updatedByUser.label" default="Updated By User" />
											</label>
					<div class="col-sm-9">
						<input type="text" placeholder="text" value="<g:fieldValue bean="${constituencyInstance.updatedByUser}" field="username"/>" id="form-field-21" class="form-control" disabled="disabled">
					</div>	
											
<%--						<span class="property-value" aria-labelledby="updatedByUser-label"><g:link controller="muser" action="show" id="${constituencyInstance?.updatedByUser?.id}">${constituencyInstance?.updatedByUser?.encodeAsHTML()}</g:link></span>--%>
					
					</div>
				</g:if>
			
			</form>
			<g:form url="[resource:constituencyInstance, action:'delete']" method="DELETE">
				<fieldset class="buttons">
					<g:link class="btn btn-primary" action="edit" resource="${constituencyInstance}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
