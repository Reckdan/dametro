...
<%--													<g:if test="${DateCollector.minus(new Date(),taskInstance.dueDate).getDays<1 }">--%>
<%--													<span class="label label-danger" style="opacity: 1;"> ${taskInstance.dueDate }</span>--%>
<%--													</g:if>--%>
<%--													<g:elseif test="${DateCollector.minus(new Date(),taskInstance.dueDate).getDays>=1 && DateCollector.minus(new Date(),taskInstance.dueDate).getDays<5 }">--%>
...
<div class="col-md-12">
		...
		<div id="create-collector" class="content scaffold-create" role="main">
			...
			<ul class="errors" role="alert">
				<g:eachError bean="${collectorInstance}" var="error">
			...
			<g:form url="[controller:'collector', action:'save']" class="form-horizontal" enctype="multipart/form-data">
				<fieldset class="form">
