...
<g:set var="entityName"
	value="${message(code: 'building.label', default: 'Building')}" />
		...
		<div id="list-building" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="accountNo" title="${message(code: 'building.accountNo.label', default: 'Account Number')}" />
					
						<g:sortableColumn property="type" title="${message(code: 'building.type.label', default: 'Property Type')}" />
					
						<g:sortableColumn property="category" title="${message(code: 'building.category.label', default: 'Property Category')}" />
					
						<g:sortableColumn property="houseaddress" title="${message(code: 'building.houseaddress.label', default: 'House Address')}" />
					
						<g:sortableColumn property="submetro" title="${message(code: 'building.submetro.label', default: 'Sub Metro')}" />
					
						<g:sortableColumn property="constituency" title="${message(code: 'building.constituency.label', default: 'Constituency')}" />
						<g:sortableColumn property="electoralarea" title="${message(code: 'building.electoralarea.label', default: 'Electoral Area')}" />
						<g:sortableColumn property="community" title="${message(code: 'building.community.label', default: 'Community')}" />
						<g:sortableColumn property="street" title="${message(code: 'building.street.label', default: 'Street')}" />
						<g:sortableColumn property="propertyUse" title="${message(code: 'building.propertyUse.label', default: 'Property Use')}" />
						<g:sortableColumn property="rateableValue" title="${message(code: 'building.rateableValue.label', default: 'Rateable Value')}" />
				...
				<tbody>
				<g:each in="${buildings}" status="i" var="buildingInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
					
						<td><g:link action="show" id="${buildingInstance.id}">${fieldValue(bean: buildingInstance, field: "accountNo")}</g:link></td>
					
						<td>${fieldValue(bean: buildingInstance, field: "type.typeName")}</td>
					
						<td>${fieldValue(bean: buildingInstance, field: "category.categoryName")}</td>
					
						<td>${fieldValue(bean: buildingInstance, field: "houseaddress")}</td>
						
						<td>${fieldValue(bean: buildingInstance, field: "submetro.submetroName")}</td>
						
						<td>${fieldValue(bean: buildingInstance, field: "constituency.constituencyName")}</td>
						<td>${fieldValue(bean: buildingInstance, field: "electoralarea.electoralareaName")}</td>
						<td>${fieldValue(bean: buildingInstance, field: "community.communityName")}</td>
						<td>${fieldValue(bean: buildingInstance, field: "street.streetName")}</td>
						<td>${fieldValue(bean: buildingInstance, field: "propertyUse.propertyUse")}</td>
						<td>${fieldValue(bean: buildingInstance, field: "rateableValue")}</td>
						<td>
														<div class="visible-md visible-lg hidden-sm hidden-xs">

													<g:link class="btn btn-xs btn-teal tooltips" data-placement="top" data-original-title="Edit" action="edit" resource="${buildingInstance}">
															<i class="fa fa-edit"></i></g:link>
													<g:link class="btn btn-xs btn-teal tooltips" data-placement="top" data-original-title="Upload Image" action="upload" resource="${buildingInstance}">
															<i class="fa fa-edit"></i></g:link>
												<sec:ifAnyGranted roles="ROLE_ADMIN,ROLE_SUPERVISOR">			
													<g:link class="btn btn-xs btn-bricky tooltips" data-placement="top" data-original-title="Remove" action="delete" resource="${buildingInstance}">
												...
												<div class="visible-xs visible-sm hidden-md hidden-lg">
													<div class="btn-group">
														...
														<ul role="menu" class="dropdown-menu pull-right">
															...
															<g:link role="menuitem" tabindex="-1" action="edit" resource="${buildingInstance}">
															<i class="fa fa-edit"></i>
															<g:message code="default.button.edit.label" default="Edit" /></g:link>
																
															</li>
															<li role="presentation">
															<g:link role="menuitem" tabindex="-1" action="upload" resource="${buildingInstance}">
															<i class="fa fa-picture"></i>
															<g:message code="default.button.upload.label" default="Upload Image" /></g:link>
															...
															<sec:ifAnyGranted roles="ROLE_ADMIN,ROLE_SUPERVISOR">
																<li role="presentation">
																	...
																	<g:link role="menuitem" tabindex="-1" action="delete" resource="${buildingInstance}">
