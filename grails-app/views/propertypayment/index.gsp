...
<%--											Add Item</a>--%>
		...
		<div id="list-propertypayment" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="propertypayment" title="${message(code: 'propertypayment.propertypayment.label', default: 'Metro Name')}" />
					
						<g:sortableColumn property="city" title="${message(code: 'propertypayment.city.label', default: 'City')}" />
					
						<g:sortableColumn property="region" title="${message(code: 'propertypayment.region.label', default: 'Region')}" />
					
						<g:sortableColumn property="organizationType" title="${message(code: 'propertypayment.organizationType.label', default: 'Organization Type')}" />
					
						<g:sortableColumn property="enquires" title="${message(code: 'propertypayment.enquires.label', default: 'Enquires')}" />
					
						<g:sortableColumn property="subpropertypayment" title="${message(code: 'propertypayment.subpropertypayment.label', default: 'Subpropertypayment')}" />
						<g:sortableColumn property="electoralArea" title="${message(code: 'propertypayment.electoralArea.label', default: 'Electoral Area')}" />
						<th>Operation</th>
					
					</tr>
				</thead>
				<tbody>
				<g:each in="${propertypayments}" status="i" var="propertypaymentInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
					
						<td><g:link action="show" id="${propertypaymentInstance.id}">${fieldValue(bean: propertypaymentInstance, field: "propertypayment")}</g:link></td>
					
						<td>${fieldValue(bean: propertypaymentInstance, field: "city")}</td>
					
						<td>${fieldValue(bean: propertypaymentInstance, field: "region")}</td>
					
						<td>${fieldValue(bean: propertypaymentInstance, field: "organizationType")}</td>
						
						<td>${fieldValue(bean: propertypaymentInstance, field: "enquires")}</td>
						
						<td>${fieldValue(bean: propertypaymentInstance, field: "subpropertypayment")}</td>
						<td>${fieldValue(bean: propertypaymentInstance, field: "electoralArea")}</td>

									<td>
														<div class="visible-md visible-lg hidden-sm hidden-xs">

													<g:link class="btn btn-xs btn-teal tooltips" data-placement="top" data-original-title="Edit" action="edit" resource="${propertypaymentInstance}">
															<i class="fa fa-edit"></i></g:link>
												<sec:ifAnyGranted roles="ROLE_ADMIN,ROLE_SUPERVISOR">			
													<g:link class="btn btn-xs btn-bricky tooltips" data-placement="top" data-original-title="Remove" action="delete" resource="${propertypaymentInstance}">
												...
												<div class="visible-xs visible-sm hidden-md hidden-lg">
													<div class="btn-group">
														...
														<ul role="menu" class="dropdown-menu pull-right">
															...
															<g:link role="menuitem" tabindex="-1" action="edit" resource="${propertypaymentInstance}">
															...
															<sec:ifAnyGranted roles="ROLE_ADMIN,ROLE_SUPERVISOR">
																<li role="presentation">
																	...
																	<g:link role="menuitem" tabindex="-1" action="delete" resource="${propertypaymentInstance}">
...
<%--				<g:paginate total="${propertypaymentInstanceCount ?: 0}" />--%>
<%--			</div>--%>
		<!-- end: PAGE CONTENT-->
				</div>
			</div>
