...
<div class="col-md-12">
		...
		<div id="show-lookupType" class="content scaffold-show" role="main">
			...
			<form class="form-horizontal">
				...
				<g:if test="${lookupTypeInstance?.typeDesc}">
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" placeholder="text" value="<g:fieldValue bean="${lookupTypeInstance}" field="typeDesc"/>" id="form-field-21" class="form-control" disabled="disabled">
					</div>									
			...
			<g:form url="[resource:lookupTypeInstance, action:'delete']" method="DELETE">
				<fieldset class="buttons">
					<g:link class="btn btn-primary" action="edit" resource="${lookupTypeInstance}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
