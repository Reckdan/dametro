...
<html>
	<head>
<g:set var="entityName" value="${message(code: 'lookupType.label', default: 'LookupType')}" />
...
<%--													<g:if test="${DateLookupType.minus(new Date(),taskInstance.dueDate).getDays<1 }">--%>
<%--													<span class="label label-danger" style="opacity: 1;"> ${taskInstance.dueDate }</span>--%>
<%--													</g:if>--%>
<%--													<g:elseif test="${DateLookupType.minus(new Date(),taskInstance.dueDate).getDays>=1 && DateLookupType.minus(new Date(),taskInstance.dueDate).getDays<5 }">--%>
...
<%--											Add Item</a>--%>
		...
		<div id="list-lookupType" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="id" title="${message(code: 'lookupType.id.label', default: 'id')}" />
					
						<g:sortableColumn property="city" title="${message(code: 'lookupType.label.label', default: 'Description')}" />
				...
				<tbody>
				<g:each in="${lookupTypes}" status="i" var="lookupTypeInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
					
						<td><g:link action="show" id="${lookupTypeInstance.id}">${fieldValue(bean: lookupTypeInstance, field: "id")}</g:link></td>
					
						<td>${fieldValue(bean: lookupTypeInstance, field: "typeDesc")}</td>
									...
									<td>
													...
													<g:link class="btn btn-xs btn-teal tooltips" data-placement="top" data-original-title="Edit" action="edit" resource="${lookupTypeInstance}">
															<i class="fa fa-edit"></i></g:link>
												<sec:ifAnyGranted roles="ROLE_ADMIN,ROLE_SUPERVISOR">			
													<g:link class="btn btn-xs btn-bricky tooltips" data-placement="top" data-original-title="Remove" action="delete" resource="${lookupTypeInstance}">
												...
												<div class="visible-xs visible-sm hidden-md hidden-lg">
													<div class="btn-group">
														...
														<ul role="menu" class="dropdown-menu pull-right">
															...
															<g:link role="menuitem" tabindex="-1" action="edit" resource="${lookupTypeInstance}">
															...
															<sec:ifAnyGranted roles="ROLE_ADMIN,ROLE_SUPERVISOR">
																<li role="presentation">
																	...
																	<g:link role="menuitem" tabindex="-1" action="delete" resource="${lookupTypeInstance}">
...
<%--				<g:paginate total="${lookupTypeInstanceCount ?: 0}" />--%>
<%--			</div>--%>
		<!-- end: PAGE CONTENT-->
				</div>
			</div>
