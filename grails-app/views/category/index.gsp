		...
		<div id="list-category" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="category" title="${message(code: 'category.code.label', default: 'Code')}" />
					
						<g:sortableColumn property="city" title="${message(code: 'category.categoryName.label', default: 'Category Name')}" />
					
						<g:sortableColumn property="region" title="${message(code: 'category.minCharge.label', default: 'Min Charge')}" />
					
						<g:sortableColumn property="organizationType" title="${message(code: 'category.type.label', default: 'Type')}" />
					
						<g:sortableColumn property="enquires" title="${message(code: 'category.gcatid.label', default: 'Line')}" />
					
						<g:sortableColumn property="subcategory" title="${message(code: 'category.datecreated.label', default: 'Date Created')}" />
						<g:sortableColumn property="electoralArea" title="${message(code: 'category.createdbyuser.label', default: 'Created By')}" />
						<th>Operation</th>
				...
				<g:each in="${categories}" status="i" var="categoryInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: categoryInstance, field: "minCharge")}</td>
					
						<td>${fieldValue(bean: categoryInstance.type, field: "typeName")}</td>
						
						<td>${fieldValue(bean: categoryInstance, field: "gcatId")}</td>
						
						<td>${fieldValue(bean: categoryInstance, field: "datecreated")}</td>
						<td>${fieldValue(bean: categoryInstance.createdByUser, field: "firstname")}</td>

									<td>
														<div class="visible-md visible-lg hidden-sm hidden-xs">

													<g:link class="btn btn-xs btn-teal tooltips" data-placement="top" data-original-title="Edit" action="edit" resource="${categoryInstance}">
															<i class="fa fa-edit"></i></g:link>
												<sec:ifAnyGranted roles="ROLE_ADMIN,ROLE_SUPERVISOR">			
													<g:link class="btn btn-xs btn-bricky tooltips" data-placement="top" data-original-title="Remove" action="delete" resource="${categoryInstance}">
												...
												<div class="visible-xs visible-sm hidden-md hidden-lg">
													<div class="btn-group">
														...
														<ul role="menu" class="dropdown-menu pull-right">
															...
															<g:link role="menuitem" tabindex="-1" action="edit" resource="${categoryInstance}">
															...
															<sec:ifAnyGranted roles="ROLE_ADMIN,ROLE_SUPERVISOR">
																<li role="presentation">
																	...
																	<g:link role="menuitem" tabindex="-1" action="delete" resource="${categoryInstance}">
