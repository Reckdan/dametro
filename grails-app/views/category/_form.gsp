...
<div class="form-group">
	...
	<div class="col-sm-9">
	<g:select id="type" name="type.id" from="${dametro.Eventtype.findAllByMetroById(1)}" optionKey="id" required="" value="${categoryInstance?.type?.id}" optionValue="typeName" class="form-control search-select"/>
	</div>
</div>
