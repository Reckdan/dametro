...
<html>
	<head>
<g:set var="entityName" value="${message(code: 'businessPayment.label', default: 'BusinessPayment')}" />
...
<%--													<g:if test="${DateBusinessPayment.minus(new Date(),taskInstance.dueDate).getDays<1 }">--%>
<%--													<span class="label label-danger" style="opacity: 1;"> ${taskInstance.dueDate }</span>--%>
<%--													</g:if>--%>
<%--													<g:elseif test="${DateBusinessPayment.minus(new Date(),taskInstance.dueDate).getDays>=1 && DateBusinessPayment.minus(new Date(),taskInstance.dueDate).getDays<5 }">--%>
...
<div class="col-md-12">
		...
		<div id="create-businessPayment" class="content scaffold-create" role="main">
			
			<g:if test="${flash.message}">
			<div class="message" role="status">${flash.message}</div>
			</g:if>
			<g:hasErrors bean="${businessPaymentInstance}">
			<ul class="errors" role="alert">
				<g:eachError bean="${businessPaymentInstance}" var="error">
			...
			<g:form class="form-horizontal" >
				<div class="form-group">
					<div class="input-group well">
						<label class="col-sm-2 control-label" for="search"> <g:message
						code="building.search.label" default="Search Business" />
						</label>
				...
				<div class="alert alert-block alert-info fade in">
					...
					<h4 class="alert-heading"><i class="fa fa-info-circle"></i> Business Info</h4>
					<p>
						
							<fieldset class="form">
								<g:render template="busform"/>
							</fieldset>
			...
			<g:form url="[controller:'businessPayment', action:'save']" class="form-horizontal" >
				<fieldset class="form">
