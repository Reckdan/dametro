...
<html>
	<head>
<g:set var="entityName" value="${message(code: 'metro.label', default: 'Category')}" />
...
<%--											Add Item</a>--%>
		...
		<div id="list-metro" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="metro" title="${message(code: 'metro.metro.label', default: 'Metro Name')}" />
					
						<g:sortableColumn property="city" title="${message(code: 'metro.city.label', default: 'City')}" />
					
						<g:sortableColumn property="region" title="${message(code: 'metro.region.label', default: 'Region')}" />
					
						<g:sortableColumn property="organizationType" title="${message(code: 'metro.organizationType.label', default: 'Organization Type')}" />
					
						<g:sortableColumn property="enquires" title="${message(code: 'metro.enquires.label', default: 'Enquires')}" />
					
						<g:sortableColumn property="submetro" title="${message(code: 'metro.submetro.label', default: 'Submetro')}" />
						<g:sortableColumn property="electoralArea" title="${message(code: 'metro.electoralArea.label', default: 'Electoral Area')}" />
						<th>Operation</th>
					
					</tr>
				</thead>
				<tbody>
				<g:each in="${metros}" status="i" var="metroInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
					
						<td><g:link action="show" id="${metroInstance.id}">${fieldValue(bean: metroInstance, field: "metro")}</g:link></td>
					
						<td>${fieldValue(bean: metroInstance, field: "city")}</td>
					
						<td>${fieldValue(bean: metroInstance, field: "region")}</td>
					
						<td>${fieldValue(bean: metroInstance, field: "organizationType")}</td>
						
						<td>${fieldValue(bean: metroInstance, field: "enquires")}</td>
						
						<td>${fieldValue(bean: metroInstance, field: "submetro")}</td>
						<td>${fieldValue(bean: metroInstance, field: "electoralArea")}</td>

									<td>
														<div class="visible-md visible-lg hidden-sm hidden-xs">

													<g:link class="btn btn-xs btn-teal tooltips" data-placement="top" data-original-title="Edit" action="edit" resource="${metroInstance}">
															<i class="fa fa-edit"></i></g:link>
												<sec:ifAnyGranted roles="ROLE_ADMIN,ROLE_SUPERVISOR">			
													<g:link class="btn btn-xs btn-bricky tooltips" data-placement="top" data-original-title="Remove" action="delete" resource="${metroInstance}">
												...
												<div class="visible-xs visible-sm hidden-md hidden-lg">
													<div class="btn-group">
														...
														<ul role="menu" class="dropdown-menu pull-right">
															...
															<g:link role="menuitem" tabindex="-1" action="edit" resource="${metroInstance}">
															...
															<sec:ifAnyGranted roles="ROLE_ADMIN,ROLE_SUPERVISOR">
																<li role="presentation">
																	...
																	<g:link role="menuitem" tabindex="-1" action="delete" resource="${metroInstance}">
...
<%--				<g:paginate total="${metroInstanceCount ?: 0}" />--%>
<%--			</div>--%>
		<!-- end: PAGE CONTENT-->
				</div>
			</div>
