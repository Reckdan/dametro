		...
		<div id="list-street" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="street" title="${message(code: 'street.streetName.label', default: 'Street Name')}" />
					
						<g:sortableColumn property="city" title="${message(code: 'street.constituency.label', default: 'Constituency')}" />
					
						<g:sortableColumn property="region" title="${message(code: 'street.submetro.label', default: 'Submetro')}" />
				...
				<tbody>
				<g:each in="${streets}" status="i" var="streetInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
					
								<td><g:link action="show" id="${streetInstance.id}">${fieldValue(bean: streetInstance, field: "streetName")}</g:link></td>
					
						<td>${fieldValue(bean: streetInstance, field: "constituency.constituencyName")}</td>
					
						<td>${fieldValue(bean: streetInstance, field: "submetro.submetroName")}</td>

									<td>
														<div class="visible-md visible-lg hidden-sm hidden-xs">

													<g:link class="btn btn-xs btn-teal tooltips" data-placement="top" data-original-title="Edit" action="edit" resource="${streetInstance}">
															<i class="fa fa-edit"></i></g:link>
												<sec:ifAnyGranted roles="ROLE_ADMIN,ROLE_SUPERVISOR">			
													<g:link class="btn btn-xs btn-bricky tooltips" data-placement="top" data-original-title="Remove" action="delete" resource="${streetInstance}">
												...
												<div class="visible-xs visible-sm hidden-md hidden-lg">
													<div class="btn-group">
														...
														<ul role="menu" class="dropdown-menu pull-right">
															...
															<g:link role="menuitem" tabindex="-1" action="edit" resource="${streetInstance}">
															...
															<sec:ifAnyGranted roles="ROLE_ADMIN,ROLE_SUPERVISOR">
																<li role="presentation">
																	...
																	<g:link role="menuitem" tabindex="-1" action="delete" resource="${streetInstance}">
