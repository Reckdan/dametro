...
<%--													<g:if test="${DateStreet.minus(new Date(),taskInstance.dueDate).getDays<1 }">--%>
<%--													<span class="label label-danger" style="opacity: 1;"> ${taskInstance.dueDate }</span>--%>
<%--													</g:if>--%>
<%--													<g:elseif test="${DateStreet.minus(new Date(),taskInstance.dueDate).getDays>=1 && DateStreet.minus(new Date(),taskInstance.dueDate).getDays<5 }">--%>
...
<div class="col-md-12">
		...
		<div id="show-street" class="content scaffold-show" role="main">
			...
			<form class="form-horizontal">
				...
				<g:if test="${streetInstance?.streetName}">
				
			<div class="form-group">
					
							<label class="col-sm-2 control-label" for="form-field-20">
												<g:message code="street.streetName.label" default="Street Name" />
											</label>
						<div class="col-sm-9">
												<input type="text" placeholder="text" value="<g:fieldValue bean="${streetInstance}" field="streetName"/>" id="form-field-21" class="form-control" disabled="disabled">
											</div>	
				...
				<g:if test="${streetInstance?.constituency}">
			<div class="form-group">
					...
					<div class="col-sm-9">
												<input type="text" placeholder="text" value="<g:fieldValue bean="${streetInstance}" field="constituency.constituencyName"/>" id="form-field-21" class="form-control" disabled="disabled">
											</div>							
				...
				<g:if test="${streetInstance?.submetro}">
			<div class="form-group">
					<label class="col-sm-2 control-label" for="form-field-20">
												<g:message code="street.submetro.label" default="Submetro" />
											</label>
						<div class="col-sm-9">
												<input type="text" placeholder="text" value="<g:fieldValue bean="${streetInstance}" field="submetro.submetroName"/>" id="form-field-21" class="form-control" disabled="disabled">
											</div>							
								</div>			
				...
				<g:if test="${streetInstance?.dateCreated}">
				<div class="form-group">
					
					<label class="col-sm-2 control-label" for="form-field-20">
												<g:message code="street.dateCreated.label" default="Date Created" />
											</label>
						<div class="col-sm-9">
												<input type="text" placeholder="text" value="<g:formatDate date="${streetInstance?.dateCreated}" />" id="form-field-21" class="form-control" disabled="disabled">
											</div>							
				...
				<g:if test="${streetInstance?.dateUpdated}">
					<div class="form-group">
					
					<label class="col-sm-2 control-label" for="form-field-20">
											<g:message code="street.dateUpdated.label" default="DateUpdated" />
											</label>
					<div class="col-sm-9">
												<input type="text" placeholder="text" value="<g:formatDate date="${streetInstance?.dateUpdated}" />" id="form-field-21" class="form-control" disabled="disabled">
											</div>							
					</div>	
				...
				<g:if test="${streetInstance?.createdByUser}">
				<div class="form-group">
					
					<label class="col-sm-2 control-label" for="form-field-20">
											<g:message code="street.createdByUser.label" default="Created By User" />
											</label>
					<div class="col-sm-9">
						<input type="text" placeholder="text" value="<g:fieldValue bean="${streetInstance?.createdByUser}" field="username"/>" id="form-field-21" class="form-control" disabled="disabled">
					</div>	
<%--						<span class="property-value" aria-labelledby="createdByUser-label"><g:link controller="muser" action="show" id="${streetInstance?.createdByUser?.id}">${streetInstance?.createdByUser?.encodeAsHTML()}</g:link></span>--%>
				</div>	
				
				</g:if>
				
				<g:if test="${streetInstance?.metro}">
				<div class="form-group">
				
					<label class="col-sm-2 control-label" for="form-field-20">
											<g:message code="street.metro.label" default="Metro" />
											</label>
					<div class="col-sm-9">
						<input type="text" placeholder="text" value="<g:fieldValue bean="${streetInstance.metro}" field="metro"/>" id="form-field-21" class="form-control" disabled="disabled">
					</div>	
				...
				<g:if test="${streetInstance?.updatedByUser}">
				
					<div class="form-group">
					<label class="col-sm-2 control-label" for="form-field-20">
											<g:message code="street.updatedByUser.label" default="Updated By User" />
											</label>
					<div class="col-sm-9">
						<input type="text" placeholder="text" value="<g:fieldValue bean="${streetInstance.updatedByUser}" field="username"/>" id="form-field-21" class="form-control" disabled="disabled">
					</div>	
											
<%--						<span class="property-value" aria-labelledby="updatedByUser-label"><g:link controller="muser" action="show" id="${streetInstance?.updatedByUser?.id}">${streetInstance?.updatedByUser?.encodeAsHTML()}</g:link></span>--%>
			...
			<g:form url="[resource:streetInstance, action:'delete']" method="DELETE">
				<fieldset class="buttons">
					<g:link class="btn btn-primary" action="edit" resource="${streetInstance}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
